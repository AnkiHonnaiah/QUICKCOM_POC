 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!       \file   amsr/asn1/builder/common/authority_key_identifier_builder_state.h
 *        \brief  ASN.1 Builder for authority key identifier.
 *
 *********************************************************************************************************************/

#ifndef LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_AUTHORITY_KEY_IDENTIFIER_BUILDER_STATE_H_
#define LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_AUTHORITY_KEY_IDENTIFIER_BUILDER_STATE_H_
...
/*!
 * \brief Builder state for Authority Key Identifier.
 */
class AuthorityKeyIdentifierBuilderState
    : public SequenceBuilderState<structure::AuthorityKeyIdentifier, AuthorityKeyIdentifierBuilderState> {
 public:
  /*!
   * \brief Constructor.
 ...
 protected:
   ...
   * \vprivate Product Private
   */
  auto DoYield() const noexcept -> amsr::core::Result<structure::AuthorityKeyIdentifier> override;
 ...
 private:
  OctetStringBuilderState key_identifier_builder_{this};           /*!< Member builder: keyIdentifier. */
  GeneralNamesBuilderState authority_cert_issuer_builder_{this};   /*!< Member builder: authorityCertIssuer. */
  IntegerBuilderState authority_cert_serial_number_builder_{this}; /*!< Member builder: authorityCertSerialNumber. */
};
...
#endif  // LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_AUTHORITY_KEY_IDENTIFIER_BUILDER_STATE_H_
