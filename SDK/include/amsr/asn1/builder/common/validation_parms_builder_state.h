 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!       \file   amsr/asn1/builder/common/validation_parms_builder_state.h
 *        \brief  Validation Param parameter.
 *
 *********************************************************************************************************************/

#ifndef LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_VALIDATION_PARMS_BUILDER_STATE_H_
#define LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_VALIDATION_PARMS_BUILDER_STATE_H_
...
/*!
 * \brief Builder state for Validation Params.
 */
class ValidationParmsBuilderState
    : public SequenceBuilderState<structure::ValidationParms, ValidationParmsBuilderState> {
 public:
  /*!
   * \brief Constructor.
 ...
 protected:
   ...
   * \vprivate Product Private
   */
  auto DoYield() const noexcept -> amsr::core::Result<structure::ValidationParms> override;
 ...
 private:
  BitStringBuilderState seed_builder_{this};       /*!< Member builder: seed */
  IntegerBuilderState pgen_counter_builder_{this}; /*!< Member builder: pgenCounter */
};
...
#endif  // LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_VALIDATION_PARMS_BUILDER_STATE_H_
