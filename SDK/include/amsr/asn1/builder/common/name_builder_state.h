 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!       \file   amsr/asn1/builder/common/name_builder_state.h
 *        \brief  ASN.1 builder for Name as per RFC 5912.
 *
 *********************************************************************************************************************/

#ifndef LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_NAME_BUILDER_STATE_H_
#define LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_NAME_BUILDER_STATE_H_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/asn1/builder/common/choice_builder_state.h"
#include "amsr/asn1/builder/common/rdn_sequence_builder.h"
...
/*!
 * \brief Builder for Name as per RFC 5912.
 */
class NameBuilderState : public ChoiceBuilderState<structure::Name, NameBuilderState> {
 public:
  /*!
   * \brief Type alias for status builder.
   */
  using ContentBuilder = amsr::core::Variant<RdnSequenceBuilder>;
  /*!
   * \brief Constructor.
 ...
 protected:
   ...
   * \vprivate Product Private
   */
  auto DoYield() const noexcept -> amsr::core::Result<structure::Name> override;
 ...
 private:
  ContentBuilder rdn_seq_builder_{}; /*!< CHOICE builder over single type. */
};
...
#endif  // LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_NAME_BUILDER_STATE_H_
