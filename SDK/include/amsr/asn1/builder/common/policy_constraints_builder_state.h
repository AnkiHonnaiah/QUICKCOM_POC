 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!       \file   amsr/asn1/builder/common/policy_constraints_builder_state.h
 *        \brief  ASN.1 Builder for PolicyConstraints
 *
 *********************************************************************************************************************/

#ifndef LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_POLICY_CONSTRAINTS_BUILDER_STATE_H_
#define LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_POLICY_CONSTRAINTS_BUILDER_STATE_H_
...
#include "amsr/asn1/structure/policy_constraints.h"
...
/*!
 * \brief Builder state for Policy Constraints.
 */
class PolicyConstraintsBuilderState
    : public SequenceBuilderState<structure::PolicyConstraints, PolicyConstraintsBuilderState> {
 public:
  /*!
   * \brief Constructor.
 ...
 protected:
   ...
   * \vprivate Product Private
   */
  auto DoYield() const noexcept -> amsr::core::Result<structure::PolicyConstraints> override;
 ...
 private:
  IntegerBuilderState require_explicit_policy_builder_{this}; /*!< Member builder: requireExplicitPolicy. */
  IntegerBuilderState inhibit_policy_mapping_builder_{this};  /*!< Member builder: inhibitPolicyMapping. */
};
...
#endif  // LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_POLICY_CONSTRAINTS_BUILDER_STATE_H_
