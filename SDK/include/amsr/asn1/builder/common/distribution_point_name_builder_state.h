 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!       \file   amsr/asn1/builder/common/distribution_point_name_builder_state.h
 *        \brief  DistributionPointName state.
 *
 *********************************************************************************************************************/

#ifndef LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_DISTRIBUTION_POINT_NAME_BUILDER_STATE_H_
#define LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_DISTRIBUTION_POINT_NAME_BUILDER_STATE_H_
...
/*!
 * \brief Builder state for DistributionPointName.
 */
class DistributionPointNameBuilderState
    : public ChoiceBuilderState<structure::DistributionPointName, DistributionPointNameBuilderState> {
 public:
  /*!
   * \brief Type alias for CHOICE content builder.
   */
  using ContentBuilder = amsr::core::Variant<GeneralNamesBuilderState, RelativeDistinguishedNameBuilderState>;
  /*!
   * \brief Constructor.
 ...
 protected:
   ...
   * \vprivate Product Private
   */
  auto DoYield() const noexcept -> amsr::core::Result<structure::DistributionPointName> override;
...
#endif  // LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_DISTRIBUTION_POINT_NAME_BUILDER_STATE_H_
