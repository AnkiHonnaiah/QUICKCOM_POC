 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!       \file   amsr/asn1/builder/common/administration_domain_name_builder_state.h
 *        \brief  Declaration of AdministrationDomainName builder state (RFC5280)
 *
 *********************************************************************************************************************/

#ifndef LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_ADMINISTRATION_DOMAIN_NAME_BUILDER_STATE_H_
#define LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_ADMINISTRATION_DOMAIN_NAME_BUILDER_STATE_H_
 ...
 */
class AdministrationDomainNameBuilderState
    : public ChoiceBuilderState<structure::AdministrationDomainName, AdministrationDomainNameBuilderState> {
 public:
  /*!
   ...
   */
  using ContentBuilder = amsr::core::Variant<NumericStringBuilderState, PrintableStringBuilderState>;
 ...
 protected:
   ...
   * \vprivate Product Private
   */
  auto DoYield() const noexcept -> amsr::core::Result<structure::AdministrationDomainName> override;
...
#endif  // LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_ADMINISTRATION_DOMAIN_NAME_BUILDER_STATE_H_
