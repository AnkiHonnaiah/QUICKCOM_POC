 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!       \file   amsr/asn1/builder/common/basic_constraint_builder_state.h
 *        \brief  Implementation of Basic Constraint Builder.
 *
 *********************************************************************************************************************/

#ifndef LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_BASIC_CONSTRAINT_BUILDER_STATE_H_
#define LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_BASIC_CONSTRAINT_BUILDER_STATE_H_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/asn1/builder/common/sequence_builder_state.h"
#include "amsr/asn1/structure/basic_constraint.h"
...
/*!
 * \brief Builder state for Basic Constraint builder state.
 */
class BasicConstraintBuilderState
    : public SequenceBuilderState<structure::BasicConstraint, BasicConstraintBuilderState> {
 public:
  /*!
   * \brief Constructor.
 ...
 protected:
   ...
   * \vprivate Product Private
   */
  auto DoYield() const noexcept -> amsr::core::Result<structure::BasicConstraint> override;
 ...
 private:
  BooleanBuilderState ca_builder_{this};                  /*!< Member builder: cA. */
  IntegerBuilderState path_len_constraint_builder_{this}; /*!< Member builder: pathLenConstraint. */
};
...
#endif  // LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_BASIC_CONSTRAINT_BUILDER_STATE_H_
