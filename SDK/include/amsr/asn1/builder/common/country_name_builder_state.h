 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!       \file   amsr/asn1/builder/common/country_name_builder_state.h
 *        \brief  Declaration of Country Name Builder state (RFC5280)
 *
 *********************************************************************************************************************/

#ifndef LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_COUNTRY_NAME_BUILDER_STATE_H_
#define LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_COUNTRY_NAME_BUILDER_STATE_H_
 ...
 */
class CountryNameBuilderState : public ChoiceBuilderState<structure::CountryName, CountryNameBuilderState> {
 public:
  /*!
 ...
 protected:
   ...
   * \vprivate Product Private
   */
  auto DoYield() const noexcept -> amsr::core::Result<structure::CountryName> override;
...
#endif  // LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_COUNTRY_NAME_BUILDER_STATE_H_
