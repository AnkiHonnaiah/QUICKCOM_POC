 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!       \file   amsr/asn1/builder/common/private_domain_name_builder_state.h
 *        \brief  Private Domain Name builder.
 *
 *********************************************************************************************************************/

#ifndef LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_PRIVATE_DOMAIN_NAME_BUILDER_STATE_H_
#define LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_PRIVATE_DOMAIN_NAME_BUILDER_STATE_H_
...
/*!
 * \brief Builder state for Private Domain Name.
 */
class PrivateDomainNameBuilderState
    : public ChoiceBuilderState<structure::PrivateDomainName, PrivateDomainNameBuilderState> {
 public:
  /*!
 ...
 protected:
   ...
   * \vprivate Product Private
   */
  auto DoYield() const noexcept -> amsr::core::Result<structure::PrivateDomainName> override;
...
#endif  // LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_PRIVATE_DOMAIN_NAME_BUILDER_STATE_H_
