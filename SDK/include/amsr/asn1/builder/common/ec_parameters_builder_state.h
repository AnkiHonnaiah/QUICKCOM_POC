 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!       \file   amsr/asn1/builder/common/ec_parameters_builder_state.h
 *        \brief  EC Parameters state.
 *
 *********************************************************************************************************************/

#ifndef LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_EC_PARAMETERS_BUILDER_STATE_H_
#define LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_EC_PARAMETERS_BUILDER_STATE_H_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/asn1/builder/common/choice_builder_state.h"
#include "amsr/asn1/structure/ec_parameters.h"
...
/*!
 * \brief Builder for EC Parameters.
 */
class EcParametersBuilderState : public ChoiceBuilderState<structure::EcParameters, EcParametersBuilderState> {
 public:
  /*!
   * \brief Constructor.
 ...
 protected:
   ...
   * \vprivate Product Private
   */
  auto DoYield() const noexcept -> amsr::core::Result<structure::EcParameters> override;
 ...
 private:
  amsr::core::Variant<OidBuilderState> named_curve_builder_{}; /*!< Member builder: namedCurve */
};
...
#endif  // LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_EC_PARAMETERS_BUILDER_STATE_H_
