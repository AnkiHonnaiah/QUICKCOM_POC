 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!       \file   amsr/asn1/builder/common/holder_builder_state.h
 *        \brief  Holder builder.
 *
 *********************************************************************************************************************/

#ifndef LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_HOLDER_BUILDER_STATE_H_
#define LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_HOLDER_BUILDER_STATE_H_
...
/*!
 * \brief Builder for Holder as per RFC 5912.
 */
class HolderBuilderState : public SequenceBuilderState<structure::Holder, HolderBuilderState> {
 public:
  /*!
   * \brief Constructor.
 ...
 protected:
   ...
   * \vprivate Product Private
   */
  auto DoYield() const noexcept -> amsr::core::Result<structure::Holder> override;
 ...
 private:
  ...
  GeneralNamesBuilderState entity_name_builder_{this};            /*!< Member builder: entityName. */
...
#endif  // LIB_VAASN1_INCLUDE_AMSR_ASN1_BUILDER_COMMON_HOLDER_BUILDER_STATE_H_
