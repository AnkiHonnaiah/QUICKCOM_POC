 ...
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file
 *        \brief  Converts textual representation of a boolean to its numerical value.
 *
 *********************************************************************************************************************/

#ifndef LIB_CHARCONV_COMMON_INCLUDE_AMSR_CHARCONV_TO_NUMBER_BOOL_H_
#define LIB_CHARCONV_COMMON_INCLUDE_AMSR_CHARCONV_TO_NUMBER_BOOL_H_
/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
...
/*!
 * \brief Converts a textual representation of a boolean to a numerical value.
 * \unit amsr::charconv::ToNumberBool
 * \vprivate Product Private
 */
template <>
class ToNumber<bool> : public internal::Buffer {
 public:
   ...
   * \steady UNKNOWN
   */
  explicit ToNumber(amsr::core::StringView buffer_in) noexcept : Buffer(buffer_in) {}
  ...
  /*!
   * \brief Converts a character sequence to its numerical value.
   ...
   * \trace SPEC-9718140, SPEC-9718152, SPEC-17702356, SPEC-17702357
   * \spec requires true; \endspec
   * \steady UNKNOWN
   * \vprivate Product Private
   */
  // SPEC-9718140 (bool), SPEC-9718152 (plus sign not valid), SPEC-17702356 (valid result), SPEC-17702357
  // (kInvalidArgument)
  amsr::core::Result<bool> Convert() noexcept;
};

}  // namespace charconv
}  // namespace amsr

#endif  // LIB_CHARCONV_COMMON_INCLUDE_AMSR_CHARCONV_TO_NUMBER_BOOL_H_
