 ...
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file
 *        \brief  Converts textual representation of a double to its numerical value.
 *
 *********************************************************************************************************************/

#ifndef LIB_CHARCONV_VECTOR_INCLUDE_AMSR_CHARCONV_TO_NUMBER_DOUBLE_H_
#define LIB_CHARCONV_VECTOR_INCLUDE_AMSR_CHARCONV_TO_NUMBER_DOUBLE_H_
/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include <type_traits>
...
/*!
 * \brief Converts a textual representation of a double to a numerical value.
 * \unit amsr::charconv::ToNumberDouble
 * \vprivate Product Private
 */
template <>
class ToNumber<double> : public internal::ParseFloatingPoint {
 public:
  ...
  /*!
   * \brief Converts a character sequence to a double value.
  ...
  amsr::core::Result<double> Convert(FPFormat const fmt) noexcept;
};

}  // namespace charconv
}  // namespace amsr

#endif  // LIB_CHARCONV_VECTOR_INCLUDE_AMSR_CHARCONV_TO_NUMBER_DOUBLE_H_
