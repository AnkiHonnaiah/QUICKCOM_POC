 ...
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file
 *        \brief  Contains the definitions of the loggers configuration parser.
 *
 *      \details
 *
 *         \unit  LogAndTrace::ConfigParser::LoggersParser
 *
 *********************************************************************************************************************/

#ifndef LIB_AMSR_LOG_INCLUDE_AMSR_LOG_INTERNAL_CONFIG_V1_LOGGERS_PARSER_H_
#define LIB_AMSR_LOG_INCLUDE_AMSR_LOG_INTERNAL_CONFIG_V1_LOGGERS_PARSER_H_
...
#include "amsr/log/internal/config/v1/logger_parser.h"
...
class LoggersParser final {
 ...
 public:
   ...
   * \endspec
   */
  explicit LoggersParser(json::JsonParser& parser) noexcept;
  /*!
   ...
   * \endspec
   */
  ~LoggersParser() noexcept;
  /*!
   * \brief Allow moving of the LoggersParser.
   * \spec
   *   requires true;
   * \endspec
   */
  LoggersParser(LoggersParser&&) noexcept;
  /*! \brief Do not allow copying of the LoggersParser. */
  LoggersParser(LoggersParser const&) noexcept = delete;
  /*!
   * \brief Allow moving of the LoggersParser.
   * \spec
   *   requires true;
  ...
  auto operator=(LoggersParser&&) & -> LoggersParser&;
  /*! \brief Do not allow copying of the LoggersParser. */
  auto operator=(LoggersParser const&) & noexcept -> LoggersParser& = delete;
   ...
   * \endspec
   */
  auto GetConfig() && noexcept -> LoggerConfigMap;
};
}  // namespace v1
}  // namespace config
}  // namespace internal
...
#endif  // LIB_AMSR_LOG_INCLUDE_AMSR_LOG_INTERNAL_CONFIG_V1_LOGGERS_PARSER_H_
