 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  socal/include/amsr/socal/r18_03/events/proxy_event_thread_driven.h
 *        \brief  This file contains the partial specialization of the ProxyEvent class.
 *
 *      \details  This specialization is used for the RuntimeProcessingMode kThreadDriven.
 *
 *********************************************************************************************************************/

#ifndef LIB_SOCAL_INCLUDE_AMSR_SOCAL_R18_03_EVENTS_PROXY_EVENT_THREAD_DRIVEN_H_
#define LIB_SOCAL_INCLUDE_AMSR_SOCAL_R18_03_EVENTS_PROXY_EVENT_THREAD_DRIVEN_H_
...
class ProxyEvent<EventSampleType, TimestampConfiguration,
  ...
  /*!
   * \brief Alias for a pair that temporary holds the updated receive handler.
   */
 ...
 public:
  ...
  /*!
   * \brief Type alias for ProxyEventSyncInterface.
   */
  using ProxyEventSyncInterface = ::amsr::socal::internal::events::ProxyEventSyncInterface;
  ...
  ~ProxyEvent() noexcept override { RemovePendingTasks(); }  // VCA_SOCAL_CALLING_DESTRUCTOR_OF_CLASS_MEMBERS
  /*!
   ...
   * - Reset the last notified subscribtion state.
   *
   ...
   * - Otherwise log a fatal message for invalid receive handler and abort.
   *
   * Calls "std::terminate()" if:
  ...
  void UnsetSubscriptionStateHandler() noexcept {
    // Unset handler only if it was set before.
 ...
 private:
   ...
   * \details Called upon every new event reception. Schedules a task in R-Port default thread-pool to
   *          invoke the event receive handler.
   * \pre         -
   * \context     Backend
   * \threadsafe  FALSE for same class instance, TRUE for different instances.
   ...
   * \endinternal
   *
   * \trace SPEC-4980117, SPEC-4980378, SPEC-8053498, SPEC-8053499
   */
  ...
  void HandleEventSubscriptionStateUpdateSync() noexcept override {
    ...
    if (notified_state != latest_notified_subscription_state_) {
      ...
      if (subscription_state_handler_ != nullptr) {
        // Do not use subscription_state_handler_ after call of handler.
  ...
  /*!
   * \brief Event subscription state change handler currently in use (Can be set only from the callback thread
   *        (reactor thread)).
   */
...
#endif  // LIB_SOCAL_INCLUDE_AMSR_SOCAL_R18_03_EVENTS_PROXY_EVENT_THREAD_DRIVEN_H_

// clang-format off
/*!
 * \exclusivearea ::amsr::socal::r18_03::events::ProxyEvent::receive_handler_lock_
 ...
 *
 * \protects ::amsr::socal::r18_03::events::ProxyEvent::new_receive_handler_pair_
 * \usedin :amsr::socal::r18_03::events::ProxyEvent::HandleEventNotificationSync
 * \usedin :amsr::socal::r18_03::events::ProxyEvent::SetReceiveHandler
 * \usedin :amsr::socal::r18_03::events::ProxyEvent::UnsetReceiveHandler
 * \usedin :amsr::socal::r18_03::events::ProxyEvent::Unsubscribe
 ...
 */
/*!
 * \exclusivearea ::amsr::socal::r18_03::events::ProxyEvent::subscription_state_handler_lock_
 * Used for protecting the concurrent modification of the current event subscription state change handler and for synchronizing the
 * unsubscription against the event subscription state change handler invocation.
 *
 * \protects ::amsr::socal::r18_03::events::ProxyEvent::new_subscription_state_handler_pair_
 * \usedin :amsr::socal::r18_03::events::ProxyEvent::HandleEventSubscriptionStateUpdateSync
 * \usedin :amsr::socal::r18_03::events::ProxyEvent::SetSubscriptionStateHandler
 * \usedin :amsr::socal::r18_03::events::ProxyEvent::UnsetSubscriptionStateHandler
 * \usedin :amsr::socal::r18_03::events::ProxyEvent::Unsubscribe
 * \exclude All other methods of a ProxyEvent object.
