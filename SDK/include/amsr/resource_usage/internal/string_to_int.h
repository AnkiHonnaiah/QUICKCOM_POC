...
#ifndef LIB_RESOURCEUSAGE_LIBOSABSTRACTION_INTERFACE_INCLUDE_AMSR_RESOURCE_USAGE_INTERNAL_STRING_TO_INT_H_
#define LIB_RESOURCEUSAGE_LIBOSABSTRACTION_INTERFACE_INCLUDE_AMSR_RESOURCE_USAGE_INTERNAL_STRING_TO_INT_H_
 ...
 * \return Integral value of the passed number.
 *
 * \error  osabstraction::OsabErrc::kApiError  (Linux) The conversion failed because the passed string did not
 *                                             contain a number or the number cannot be stored in
 *                                             an unsigned 64 bit integral type.
 * \error  osabstraction::OsabErrc::kApiError  (QNX) Api is not supported.
 *
 * \context         ANY
 *
 * \pre             -
 ...
 * \threadsafe      FALSE
 */
::amsr::core::Result<std::uint64_t> ConvertToUint64(::amsr::core::StringView const& str) noexcept;

}  // namespace internal
}  // namespace resource_usage
}  // namespace amsr

#endif  // LIB_RESOURCEUSAGE_LIBOSABSTRACTION_INTERFACE_INCLUDE_AMSR_RESOURCE_USAGE_INTERNAL_STRING_TO_INT_H_
