 ...
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file
 *         \brief  Generic proxy event
 *         \unit   SomeIpBinding::SomeIpBindingGenericLayer::Events::GenericProxyEvent
 *
 *********************************************************************************************************************/
#ifndef LIB_SOMEIP_BINDING_GENERIC_LAYER_INCLUDE_AMSR_SOMEIP_BINDING_GENERIC_LAYER_INTERNAL_EVENTS_GENERIC_PROXY_EVENT_H_
#define LIB_SOMEIP_BINDING_GENERIC_LAYER_INCLUDE_AMSR_SOMEIP_BINDING_GENERIC_LAYER_INTERNAL_EVENTS_GENERIC_PROXY_EVENT_H_
...
/*!
 * \brief GenericProxyEvent class
 */
class GenericProxyEvent final : public amsr::socal::internal::events::GenericProxyEventBackendInterface,
                                public amsr::someip_binding_core::internal::events::EventNotificationInterface {
 public:
  /*!
   * \brief       Constructor.
   * \param[in] client_event       The client event.
   * \pre         -
   * \context     App
   * \threadsafe  TRUE
   * \reentrant   FALSE
   ...
   * \steady      FALSE
   */
  explicit GenericProxyEvent(std::unique_ptr<amsr::someip_binding_core::internal::events::ClientEvent> client_event);
   ...
   * \steady      FALSE
   */
  void Subscribe(std::size_t const cache_size) noexcept final;

  /*!
   * \brief Unsubscribes from the event.
   * \pre         All samples need to be returned to the cache.
   * \context     App
   * \threadsafe  FALSE
  ...
  ReadSamplesResult ReadSamples(std::size_t const max_samples,
                                CallableReadSamplesResult const& callable_sample_result) noexcept final;
   ...
   * \steady      TRUE
   */
  ::ara::com::SubscriptionState GetSubscriptionState() const noexcept final;
   ...
   * \steady      TRUE
   */
  std::size_t GetFreeSampleCount() const noexcept final;
 ...
 private:
  ...
  std::shared_ptr<GenericProxyEventNotificationHandler> notification_handler_;
...
#endif  // LIB_SOMEIP_BINDING_GENERIC_LAYER_INCLUDE_AMSR_SOMEIP_BINDING_GENERIC_LAYER_INTERNAL_EVENTS_GENERIC_PROXY_EVENT_H_
