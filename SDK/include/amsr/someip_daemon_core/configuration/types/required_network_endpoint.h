 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  required_network_endpoint.h
 *        \brief  Required Network Endpoint
 *
 *      \details  -
 *
 *********************************************************************************************************************/

#ifndef LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CONFIGURATION_TYPES_REQUIRED_NETWORK_ENDPOINT_H_
#define LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CONFIGURATION_TYPES_REQUIRED_NETWORK_ENDPOINT_H_
...
#include "amsr/someip_daemon_core/configuration/types/required_port.h"
...
/*!
 * \brief Required Network Endpoint that defines the IP Address / port of the machine.
 */
struct RequiredNetworkEndpoint {
  /*!
   ...
   *  IP-Unicast case.
   */
  ::ara::core::Optional<configuration::types::RequiredPort> udp_port;
   ...
   *  IP-Unicast case.
   */
  ::ara::core::Optional<configuration::types::RequiredPort> tcp_port;
};
...
#endif  // LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CONFIGURATION_TYPES_REQUIRED_NETWORK_ENDPOINT_H_
