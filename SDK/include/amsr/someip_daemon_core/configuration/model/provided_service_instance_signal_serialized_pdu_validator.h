 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  provided_service_instance_signal_serialized_pdu_validator.h
 *        \brief  Validates Configuration object 'ProvidedServiceInstanceSignalSerializedPdu'.
 *********************************************************************************************************************/
#ifndef LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CONFIGURATION_MODEL_PROVIDED_SERVICE_INSTANCE_SIGNAL_SERIALIZED_PDU_VALIDATOR_H_
#define LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CONFIGURATION_MODEL_PROVIDED_SERVICE_INSTANCE_SIGNAL_SERIALIZED_PDU_VALIDATOR_H_
/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include <chrono>
...
/*!
 * \brief Groups consistency checks for 'provided service instance signal serialized PDU' elements.
 */
class ProvidedServiceInstanceSignalSerializedPduValidator final {
 public:
  /*!
  ...
  static char const* ValidationResultToString(ValidationResult validation_result) {
    ...
    switch (validation_result) {
      ...
      case ValidationResult::kMissingPduId:
        ret = "The PDU ID is missing";
        break;

      case ValidationResult::kMissingEventId:
        ret = "The Event ID is missing";
        break;
    }
   ...
   * \param[in] pdu The 'provided service instance signal serialized pdu' element to verify.
   ...
   * \endinternal
   */
  static ValidationResult Check(ProvidedServiceInstanceSignalSerializedPduObject const& pdu) noexcept {
...
#endif  // LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CONFIGURATION_MODEL_PROVIDED_SERVICE_INSTANCE_SIGNAL_SERIALIZED_PDU_VALIDATOR_H_
