 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  provided_service_instance_signal_serialized_pdus_parser.h
 *        \brief
 *
 *********************************************************************************************************************/
#ifndef LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CONFIGURATION_PARSING_PROVIDED_SERVICE_INSTANCE_SIGNAL_SERIALIZED_PDUS_PARSER_H_
#define LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CONFIGURATION_PARSING_PROVIDED_SERVICE_INSTANCE_SIGNAL_SERIALIZED_PDUS_PARSER_H_
/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include <cstddef>
...
#include "amsr/someip_daemon_core/configuration/model/provided_service_instance_signal_serialized_pdu_object.h"
#include "amsr/someip_daemon_core/configuration/model/provided_service_instance_signal_serialized_pdu_validator.h"
...
/*!
 * \brief Parses a container of 'provided service instance signal serialized pdu'.
 */
class ProvidedServiceInstanceSignalSerializedPduParser final
    : public amsr::json::Parser<ProvidedServiceInstanceSignalSerializedPduParser> {
 public:
  /*!
   * \brief Type-alias for parser base class.
   */
  using Parser = amsr::json::Parser<ProvidedServiceInstanceSignalSerializedPduParser>;

  /*!
   * \brief Type-alias for used validation class.
   */
  using Validation = configuration::model::ProvidedServiceInstanceSignalSerializedPduValidator;
   ...
   * \steady FALSE
   */
  ProvidedServiceInstanceSignalSerializedPduParser(
   ...
   * \steady FALSE
   */
  ~ProvidedServiceInstanceSignalSerializedPduParser() final = default;

  /*!
   * \brief Deleted copy constructor.
   */
  ProvidedServiceInstanceSignalSerializedPduParser(ProvidedServiceInstanceSignalSerializedPduParser const&) = delete;

  /*!
   * \brief Deleted move constructor.
   */
  ProvidedServiceInstanceSignalSerializedPduParser(ProvidedServiceInstanceSignalSerializedPduParser&&) = delete;

  /*!
   * \brief Deleted copy assignment operator.
   */
  auto operator=(ProvidedServiceInstanceSignalSerializedPduParser const&)
      -> ProvidedServiceInstanceSignalSerializedPduParser& = delete;

  /*!
   * \brief Deleted move assignment operator.
   */
  auto operator=(ProvidedServiceInstanceSignalSerializedPduParser&&)
      -> ProvidedServiceInstanceSignalSerializedPduParser& = delete;
 ...
 private:
   ...
   */
  model::ProvidedServiceInstanceSignalSerializedPduObject pdu_wrapper_;
};
...
#endif  // LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CONFIGURATION_PARSING_PROVIDED_SERVICE_INSTANCE_SIGNAL_SERIALIZED_PDUS_PARSER_H_
