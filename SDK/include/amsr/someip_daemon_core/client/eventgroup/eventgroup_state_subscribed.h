 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  eventgroup_state_subscribed.h
 *        \brief  Client eventgroup state subscribed
 *
 *      \details  -
 *
 *********************************************************************************************************************/

#ifndef LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CLIENT_EVENTGROUP_EVENTGROUP_STATE_SUBSCRIBED_H_
#define LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CLIENT_EVENTGROUP_EVENTGROUP_STATE_SUBSCRIBED_H_
...
/*!
 * \brief Service Discovery Client eventgroup state 'SUBSCRIBED'.
 */
class EventgroupStateSubscribed final : public EventgroupState {
 public:
  /*!
   * \brief   Constructor of EventgroupStateSubscribed.
   * \steady  FALSE
   */
  explicit EventgroupStateSubscribed(someip_protocol::internal::EventgroupId const eventgroup_id) noexcept;
  ...
  ~EventgroupStateSubscribed() noexcept = default;

  EventgroupStateSubscribed() = delete;
  EventgroupStateSubscribed(EventgroupStateSubscribed const&) = delete;
  EventgroupStateSubscribed(EventgroupStateSubscribed&&) = delete;
  EventgroupStateSubscribed& operator=(EventgroupStateSubscribed const&) & = delete;
  EventgroupStateSubscribed& operator=(EventgroupStateSubscribed&&) & = delete;
 ...
 private:
  ...
  someip_daemon_core::logging::AraComLogger logger_{
      ...
      ara::core::StringView{"EventgroupStateSubscribed"}};
};
...
#endif  // LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CLIENT_EVENTGROUP_EVENTGROUP_STATE_SUBSCRIBED_H_
