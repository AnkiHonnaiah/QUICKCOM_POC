 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  eventgroup_state_subscription_pending.h
 *        \brief  Client eventgroup state subscription pending
 *
 *      \details  -
 *
 *********************************************************************************************************************/

#ifndef LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CLIENT_EVENTGROUP_EVENTGROUP_STATE_SUBSCRIPTION_PENDING_H_
#define LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CLIENT_EVENTGROUP_EVENTGROUP_STATE_SUBSCRIPTION_PENDING_H_
...
/*!
 * \brief Service Discovery Client Eventgroup state 'SUBSCRIPTION_PENDING'.
 */
class EventgroupStateSubscriptionPending final : public EventgroupState {
 public:
  /*!
   * \brief   Constructor of EventgroupStateSubscriptionPending.
   * \steady  FALSE
   */
  explicit EventgroupStateSubscriptionPending(someip_protocol::internal::EventgroupId const eventgroup_id) noexcept;

  /*!
   * \brief   Default destructor of EventgroupStateSubscribed
   * \steady  FALSE
   */
  ...
  ~EventgroupStateSubscriptionPending() noexcept = default;

  EventgroupStateSubscriptionPending() = delete;
  EventgroupStateSubscriptionPending(EventgroupStateSubscriptionPending const&) = delete;
  EventgroupStateSubscriptionPending(EventgroupStateSubscriptionPending&&) = delete;
  EventgroupStateSubscriptionPending& operator=(EventgroupStateSubscriptionPending const&) & = delete;
  EventgroupStateSubscriptionPending& operator=(EventgroupStateSubscriptionPending&&) & = delete;
   ...
   * \context App
   * \steady  FALSE
   * \trace SPEC-10144864, SPEC-10144865
   */
 ...
 private:
  ...
  someip_daemon_core::logging::AraComLogger logger_{
      ...
      ara::core::StringView{"EventgroupStateSubscriptionPending"}};
};
...
#endif  // LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CLIENT_EVENTGROUP_EVENTGROUP_STATE_SUBSCRIPTION_PENDING_H_
