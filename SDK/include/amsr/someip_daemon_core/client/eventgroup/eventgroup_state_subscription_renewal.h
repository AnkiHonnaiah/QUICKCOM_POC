 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  eventgroup_state_subscription_renewal.h
 *        \brief  A service discovery client eventgroup state subscription renewal
 *
 *      \details  -
 *
 *********************************************************************************************************************/

#ifndef LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CLIENT_EVENTGROUP_EVENTGROUP_STATE_SUBSCRIPTION_RENEWAL_H_
#define LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CLIENT_EVENTGROUP_EVENTGROUP_STATE_SUBSCRIPTION_RENEWAL_H_
 ...
 */
class EventgroupStateSubscriptionRenewal final : public EventgroupState {
 public:
  /*!
   * \brief   Constructor of EventgroupStateSubscriptionRenewal.
   * \steady  FALSE
   */
  explicit EventgroupStateSubscriptionRenewal(someip_protocol::internal::EventgroupId const eventgroup_id) noexcept;

  /*!
   * \brief   Default destructor of EventgroupStateSubscriptionRenewal
   * \steady  FALSE
   */
  ...
  ~EventgroupStateSubscriptionRenewal() noexcept = default;

  EventgroupStateSubscriptionRenewal() = delete;
  EventgroupStateSubscriptionRenewal(EventgroupStateSubscriptionRenewal const&) = delete;
  EventgroupStateSubscriptionRenewal(EventgroupStateSubscriptionRenewal&&) = delete;
  EventgroupStateSubscriptionRenewal& operator=(EventgroupStateSubscriptionRenewal const&) & = delete;
  EventgroupStateSubscriptionRenewal& operator=(EventgroupStateSubscriptionRenewal&&) & = delete;
 ...
 private:
  ...
  someip_daemon_core::logging::AraComLogger logger_{
      ...
      ara::core::StringView{"EventgroupStateSubscriptionRenewal"}};
};
...
#endif  // LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_CLIENT_EVENTGROUP_EVENTGROUP_STATE_SUBSCRIPTION_RENEWAL_H_
