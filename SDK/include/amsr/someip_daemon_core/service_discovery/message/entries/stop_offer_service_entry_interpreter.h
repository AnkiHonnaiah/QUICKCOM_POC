 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  stop_offer_service_entry_interpreter.h
 *        \brief  -
 *
 *      \details  -
 *
...
#ifndef LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_SERVICE_DISCOVERY_MESSAGE_ENTRIES_STOP_OFFER_SERVICE_ENTRY_INTERPRETER_H_
#define LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_SERVICE_DISCOVERY_MESSAGE_ENTRIES_STOP_OFFER_SERVICE_ENTRY_INTERPRETER_H_
...
/*!
 * \brief Interpretation of SOME/IP stop offer service discovery messages
 */
class StopOfferServiceEntryInterpreter final {
 public:
  StopOfferServiceEntryInterpreter() = delete;
  ~StopOfferServiceEntryInterpreter() = delete;
  StopOfferServiceEntryInterpreter(StopOfferServiceEntryInterpreter const &) = delete;
  StopOfferServiceEntryInterpreter(StopOfferServiceEntryInterpreter &&) = delete;
  StopOfferServiceEntryInterpreter &operator=(StopOfferServiceEntryInterpreter const &) & = delete;
  StopOfferServiceEntryInterpreter &operator=(StopOfferServiceEntryInterpreter &&) & = delete;

  /*!
   * \brief Interprets a Stop Offer Service Entry
   ...
   * \trace SPEC-10144608
   */
  static ara::core::Result<message::entries::StopOfferServiceEntry> Interpret(
      message::entries::ServiceDiscoveryEntry const &entry,
      message::options::ServiceDiscoveryOptionContainer const &options);

  /*!
   * \brief Specific implementation of the option interpreter interface for StopOfferService entries
   */
 private:
...
#endif  // LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_SERVICE_DISCOVERY_MESSAGE_ENTRIES_STOP_OFFER_SERVICE_ENTRY_INTERPRETER_H_
