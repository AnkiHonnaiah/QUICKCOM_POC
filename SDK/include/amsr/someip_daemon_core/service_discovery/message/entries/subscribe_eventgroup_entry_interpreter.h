 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  subscribe_eventgroup_entry_interpreter.h
 *        \brief  -
 *
 *      \details  -
 *
...
#ifndef LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_SERVICE_DISCOVERY_MESSAGE_ENTRIES_SUBSCRIBE_EVENTGROUP_ENTRY_INTERPRETER_H_
#define LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_SERVICE_DISCOVERY_MESSAGE_ENTRIES_SUBSCRIBE_EVENTGROUP_ENTRY_INTERPRETER_H_
...
/*!
 * \brief Interpretation of SOME/IP subscribe eventgroup discovery messages
 */
class SubscribeEventgroupEntryInterpreter final {
 public:
  SubscribeEventgroupEntryInterpreter() = delete;
  ~SubscribeEventgroupEntryInterpreter() = delete;
  SubscribeEventgroupEntryInterpreter(SubscribeEventgroupEntryInterpreter const &) = delete;
  SubscribeEventgroupEntryInterpreter(SubscribeEventgroupEntryInterpreter &&) = delete;
  SubscribeEventgroupEntryInterpreter &operator=(SubscribeEventgroupEntryInterpreter const &) & = delete;
  SubscribeEventgroupEntryInterpreter &operator=(SubscribeEventgroupEntryInterpreter &&) & = delete;
  /*!
   * \brief Interprets a Subscribe Eventgroup Entry
   ...
   * \trace SPEC-10144608
   */
  static ara::core::Result<message::entries::SubscribeEventgroupEntry> Interpret(
      message::entries::ServiceDiscoveryEntry const &entry,
      message::options::ServiceDiscoveryOptionContainer const &options);

 private:
  /*!
   * \brief Specific implementation of the option interpreter interface for SubscribeEventgroup entries
   */
...
#endif  // LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_SERVICE_DISCOVERY_MESSAGE_ENTRIES_SUBSCRIBE_EVENTGROUP_ENTRY_INTERPRETER_H_
