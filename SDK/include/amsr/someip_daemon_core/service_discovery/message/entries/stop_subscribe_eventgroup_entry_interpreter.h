 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  stop_subscribe_eventgroup_entry_interpreter.h
 *        \brief  -
 *
 *      \details  -
 *
...
#ifndef LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_SERVICE_DISCOVERY_MESSAGE_ENTRIES_STOP_SUBSCRIBE_EVENTGROUP_ENTRY_INTERPRETER_H_
#define LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_SERVICE_DISCOVERY_MESSAGE_ENTRIES_STOP_SUBSCRIBE_EVENTGROUP_ENTRY_INTERPRETER_H_
...
/*!
 * \brief Interpretation of SOME/IP stop subscribe eventgroup discovery messages
 */
class StopSubscribeEventgroupEntryInterpreter final {
 public:
  StopSubscribeEventgroupEntryInterpreter() = delete;
  ~StopSubscribeEventgroupEntryInterpreter() = delete;
  StopSubscribeEventgroupEntryInterpreter(StopSubscribeEventgroupEntryInterpreter const &) = delete;
  StopSubscribeEventgroupEntryInterpreter(StopSubscribeEventgroupEntryInterpreter &&) = delete;
  StopSubscribeEventgroupEntryInterpreter &operator=(StopSubscribeEventgroupEntryInterpreter const &) & = delete;
  StopSubscribeEventgroupEntryInterpreter &operator=(StopSubscribeEventgroupEntryInterpreter &&) & = delete;
  /*!
   * \brief Interprets a Stop Subscribe Eventgroup Entry
   * \param[in] entry   The service discovery entry
   * \param[in] options The service discovery options container
   * \return A result with the interpreted subscribe eventgroup entry or containing an error.
   *
   ...
   *                                                          entries::StopSubscribeEventgroupEntry
   *
   * \pre         -
   * \context Network
   * \steady FALSE
   ...
   * \trace SPEC-10144608
   */
  static ara::core::Result<message::entries::StopSubscribeEventgroupEntry> Interpret(
      message::entries::ServiceDiscoveryEntry const &entry,
      message::options::ServiceDiscoveryOptionContainer const &options);

 private:
  /*!
   * \brief Specific implementation of the option interpreter interface for StopSubscribeEventgroup entries
   */
...
#endif  // LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_SERVICE_DISCOVERY_MESSAGE_ENTRIES_STOP_SUBSCRIBE_EVENTGROUP_ENTRY_INTERPRETER_H_
