 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  service_discovery_client_state_main_phase.h
 *        \brief  -
 *
 *      \details  -
 *
...
#ifndef LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_FIND_SERVICE_SERVICE_DISCOVERY_CLIENT_STATE_MAIN_PHASE_H_
#define LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_FIND_SERVICE_SERVICE_DISCOVERY_CLIENT_STATE_MAIN_PHASE_H_
...
/*!
 * \brief Service Discovery Client state 'MAIN_PHASE'.
 * \trace SPEC-10144722
 * \trace SPEC-10144767
 */
class ServiceDiscoveryClientStateMainPhase final : public ServiceDiscoveryClientState {
 public:
  /*!
   * \brief Constructor of ServiceDiscoveryClientStateMainPhase.
   * \context ANY (Init or during runtime for Instance ID = ALL)
   * \steady FALSE
   */
  ServiceDiscoveryClientStateMainPhase() noexcept;
  ...
  ~ServiceDiscoveryClientStateMainPhase() noexcept override = default;

  ServiceDiscoveryClientStateMainPhase(ServiceDiscoveryClientStateMainPhase const&) = delete;
  ServiceDiscoveryClientStateMainPhase(ServiceDiscoveryClientStateMainPhase&&) = delete;
  ServiceDiscoveryClientStateMainPhase& operator=(ServiceDiscoveryClientStateMainPhase const&) & = delete;
  ServiceDiscoveryClientStateMainPhase& operator=(ServiceDiscoveryClientStateMainPhase&&) & = delete;
 ...
 private:
  ...
  someip_daemon_core::logging::AraComLogger logger_{
      ...
      ara::core::StringView{"ServiceDiscoveryClientStateMainPhase"}};
};
...
#endif  // LIB_SOMEIP_DAEMON_CORE_INCLUDE_AMSR_SOMEIP_DAEMON_CORE_SERVICE_DISCOVERY_STATE_MACHINE_CLIENT_FIND_SERVICE_SERVICE_DISCOVERY_CLIENT_STATE_MAIN_PHASE_H_
