 ...
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file
 *        \brief  Memory provider for shared memory.
 *
 *
 *      \details  -
 *
...
#ifndef LIB_COMMON_LIBOSABSTRACTION_INTERFACE_INCLUDE_AMSR_MEMORY_SHARED_MEMORY_PROVIDER_H_
#define LIB_COMMON_LIBOSABSTRACTION_INTERFACE_INCLUDE_AMSR_MEMORY_SHARED_MEMORY_PROVIDER_H_
 ...
 */
class SharedMemoryProvider final : public SharedMemoryProviderInterface {  // VCA_OSA_MOLE_1298
 public:
  /*!
   * \brief       Allocates a new shared memory object and memory maps it.
   *
  ...
  /*!
   * \brief       Allocates a new shared memory object and memory maps a part of it.
   *
   ...
   *                                                                offset and/or passed size is invalid.
   * \error       osabstraction::OsabErrc::kResource                Not enough system resources to create or map shared
   *                                                                memory object.
   * \error       osabstraction::OsabErrc::kInsufficientPrivileges  Not allowed to create shared memory object.
   *
...
#endif  // LIB_COMMON_LIBOSABSTRACTION_INTERFACE_INCLUDE_AMSR_MEMORY_SHARED_MEMORY_PROVIDER_H_
