...
#ifndef LIB_PTP_IMPL_LIBOSABSTRACTION_INTERFACE_INCLUDE_AMSR_PTP_ETHERNET_ADDRESS_H_
#define LIB_PTP_IMPL_LIBOSABSTRACTION_INTERFACE_INCLUDE_AMSR_PTP_ETHERNET_ADDRESS_H_
...
class EthernetAddress final {
 public:
   ...
   */
  static constexpr std::size_t kAddressBytes{internal::kEthernetAddressLength};
...
#endif  // LIB_PTP_IMPL_LIBOSABSTRACTION_INTERFACE_INCLUDE_AMSR_PTP_ETHERNET_ADDRESS_H_
