 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  provided_service_instance_config.h
 *        \brief  Configuration for the ProvidedServiceInstance.
 *        \unit   SomeIpBinding::SomeIpBinding::Configuration::JsonParser::JsonConfigTypes
 *
 *********************************************************************************************************************/

#ifndef LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PROVIDED_SERVICE_INSTANCE_CONFIG_H_
#define LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PROVIDED_SERVICE_INSTANCE_CONFIG_H_
...
/*!
 * \brief Struct to hold the data for a provided service instance.
 */
// VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
class ProvidedServiceInstanceConfig {
 public:
  ...
  /*!
   * \brief Getter implementation for the provided service e2e props configurations of an instance.
   ...
   * \return a reference to the service interface configuration.
   * \pre -
   * \context App
   * \threadsafe FALSE
   * \reentrant FALSE
   ...
   * \param[in] service_interface_config Reference to the service interface configuration.
   * \pre -
   * \context Init
   * \threadsafe FALSE
   * \reentrant FALSE
 ...
 */
class ProvidedServiceInstanceIdentifierComparator {
 public:
  /*!
  ...
  auto operator()(ProvidedServiceInstanceConfig const& lhs, ProvidedServiceInstanceConfig const& rhs) const noexcept
      -> bool {
    bool result{true};
...
#endif  // LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PROVIDED_SERVICE_INSTANCE_CONFIG_H_
