 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  required_service_instance_parser.h
 *        \brief  JSON parser for a 'RequiredServiceInstance'.
 *        \unit   SomeIpBinding::SomeIpBinding::Configuration::JsonParser::RequiredServiceInstanceParser
 *
 *********************************************************************************************************************/

#ifndef LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PARSING_REQUIRED_SERVICE_INSTANCE_PARSER_H_
#define LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PARSING_REQUIRED_SERVICE_INSTANCE_PARSER_H_
...
class RequiredServiceInstanceParser final : public ::amsr::json::v2::SingleObjectParser {
 public:
   ...
   * \param[in] config Reference to required service instance config.
   * \pre -
   * \context Init.
   */
  RequiredServiceInstanceParser(amsr::json::JsonData& json, RequiredServiceInstanceConfig& config) noexcept;
 ...
 private:
  ...
  /*!
   * \brief JSON key for minor version.
   */
  ...
  /*! Reference to required service instance config. */
...
#endif  // LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PARSING_REQUIRED_SERVICE_INSTANCE_PARSER_H_
