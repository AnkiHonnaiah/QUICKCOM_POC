 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  operation_config_parser.h
 *        \brief  JSON parser for a operation deployment.
 *        \unit   SomeIpBinding::SomeIpBinding::Configuration::JsonParser::OperationConfigParser
 *
 *********************************************************************************************************************/

#ifndef LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PARSING_OPERATION_CONFIG_PARSER_H_
#define LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PARSING_OPERATION_CONFIG_PARSER_H_
...
/*!
 * \brief   Parser for the Operation JSON configuration.
 ...
 */
class OperationConfigParser final : public ::amsr::json::v2::SingleObjectParser {
 public:
  /*!
  ...
  /*!
   * \brief Name alias for amsr::someip_binding::internal::configuration::OperationConfig.
   */
  using OperationConfig = ::amsr::someip_binding::internal::configuration::OperationConfig;
   ...
   * \synchronous TRUE
   */
  OperationConfigParser(amsr::json::JsonData& json, OperationConfig& config) noexcept;
  ...
  ~OperationConfigParser() final = default;

  OperationConfigParser(OperationConfigParser const&) noexcept = delete;
  OperationConfigParser& operator=(OperationConfigParser const&) & = delete;
  OperationConfigParser(OperationConfigParser&&) noexcept = delete;
  OperationConfigParser& operator=(OperationConfigParser&&) & = delete;
 ...
 private:
  /*! JSON key for the operation id. */
  static constexpr amsr::core::StringView kOperationIdKey{"id"_sv};

  /*!
   * \brief       Parse the operation ID from JSON.
   * \return      Parser result.
   * \error       SomeIpBindingErrc::json_parsing_failure if JSON parsing failed.
   *
   * \pre         -
   ...
   * \endspec
   */
  ParserResult ParseOperationId() noexcept;
  ...
  std::size_t number_of_operation_ids_found_{0}; /*!< Number of key 'operation_id' found.*/
...
#endif  // LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PARSING_OPERATION_CONFIG_PARSER_H_
