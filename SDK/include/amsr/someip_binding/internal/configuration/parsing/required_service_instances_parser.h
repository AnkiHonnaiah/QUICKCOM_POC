 ...
 *        \unit   SomeIpBinding::SomeIpBinding::Configuration::JsonParser::RequiredServiceInstancesParser
 *
 *********************************************************************************************************************/

#ifndef LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PARSING_REQUIRED_SERVICE_INSTANCES_PARSER_H_
#define LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PARSING_REQUIRED_SERVICE_INSTANCES_PARSER_H_
...
#include "amsr/someip_binding/internal/configuration/parsing/required_service_instance_parser.h"
...
/*!
 * \brief Parser for the required service instances element inside the SomeIpBinding configuration.
 */
// VCA_SLC_23_SOMEIPBINDING_DEFAULT_CTOR_DTOR_MOLE_1298
class RequiredServiceInstancesParser final : public ::amsr::json::v2::SingleArrayParser {
 public:
  /*!
  ...
  /*!
   * \brief Constructor for RequiredServiceInstanceParser.
   ...
   * \context Init
   */
  RequiredServiceInstancesParser(amsr::json::JsonData& json, configuration::IpcChannelConfig& config) noexcept;
 ...
 protected:
   ...
   * \endspec
   */
  RequiredServiceInstanceParser::ParserResult OnElement() noexcept final;
...
#endif  // LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PARSING_REQUIRED_SERVICE_INSTANCES_PARSER_H_
