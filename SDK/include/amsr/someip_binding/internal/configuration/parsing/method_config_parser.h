 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  method_config_parser.h
 *        \brief  JSON parser for a method configuration.
 *        \unit   SomeIpBinding::SomeIpBinding::Configuration::JsonParser::MethodConfigParser
 *
 *********************************************************************************************************************/

#ifndef LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PARSING_METHOD_CONFIG_PARSER_H_
#define LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PARSING_METHOD_CONFIG_PARSER_H_
...
/*!
 * \brief   Parser for the method JSON configuration.
 ...
 */
class MethodConfigParser final : public ::amsr::json::v2::SingleObjectParser {
 public:
  /*!
  ...
  /*!
   * \brief Name alias for amsr::someip_binding::internal::configuration::MethodConfig.
   */
  using MethodConfig = ::amsr::someip_binding::internal::configuration::MethodConfig;
   ...
   * \synchronous TRUE
   */
  MethodConfigParser(amsr::json::JsonData& json, MethodConfig& config) noexcept;
  ...
  ~MethodConfigParser() final = default;

  MethodConfigParser(MethodConfigParser const&) noexcept = delete;
  MethodConfigParser& operator=(MethodConfigParser const&) & = delete;
  MethodConfigParser(MethodConfigParser&&) noexcept = delete;
  MethodConfigParser& operator=(MethodConfigParser&&) & = delete;
 ...
 private:
  ...
  static constexpr amsr::core::StringView kMethodIdKey{"id"_sv};

  /*! JSON key for the shortnamepath. */
  static constexpr amsr::core::StringView kShortnameKey{"shortname"_sv};

  /*! JSON key for the isFireAndForget flag. */
  static constexpr amsr::core::StringView kIsFireAndForgetKey{"isFireAndForget"_sv};
   ...
   * \endspec
   */
  ParserResult ParseMethodId() noexcept;
  ...
  /*!
   * \brief       Parse the isFireAndForget flag from JSON.
   * \return      Parser result.
   * \error       SomeIpBindingErrc::json_parsing_failure if JSON parsing failed.
   *
   * \pre         -
   ...
   * \endspec
   */
  ParserResult ParseIsFireAndForget() noexcept;
  ...
  std::size_t number_of_is_fire_and_forget_found_{0}; /*!< Number of key 'isFireAndForget' found.*/
...
#endif  // LIB_SOMEIP_BINDING_INCLUDE_AMSR_SOMEIP_BINDING_INTERNAL_CONFIGURATION_PARSING_METHOD_CONFIG_PARSER_H_
