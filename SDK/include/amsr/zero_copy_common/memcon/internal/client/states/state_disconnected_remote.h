 ...
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file
 *        \brief  Definition of class StateDisconnectedRemote.
 *         \unit  ZeroCopyCommon::MemCon::Client
 *
 *********************************************************************************************************************/
#ifndef LIB_MEMCON_INCLUDE_AMSR_ZERO_COPY_COMMON_MEMCON_INTERNAL_CLIENT_STATES_STATE_DISCONNECTED_REMOTE_H_
#define LIB_MEMCON_INCLUDE_AMSR_ZERO_COPY_COMMON_MEMCON_INTERNAL_CLIENT_STATES_STATE_DISCONNECTED_REMOTE_H_
...
/*!
 * \brief StateDisconnectedRemote state.
 * \vprivate Component Private
 */
class StateDisconnectedRemote final : public StateBase {
 public:
  /*!
   * \brief Construct a StateDisconnectedRemote.
   ...
   * \vprivate Component Private
   */
  StateDisconnectedRemote(StateMachineBase& state_machine, ::ara::log::Logger& logger,
                          side_channel::ClientSideChannel& side_channel, LogicClientPtr& logic_client,
                          NumSlots::Type& slot_tokens_given_out) noexcept;

  /*!
   * \brief Do not construct a StateDisconnectedRemote by copying.
   * \vprivate Component Private
   */
  StateDisconnectedRemote(StateDisconnectedRemote const&) noexcept = delete;

  /*!
   * \brief Do not construct a StateDisconnectedRemote by moving.
   * \vprivate Component Private
   */
  StateDisconnectedRemote(StateDisconnectedRemote&&) noexcept = delete;

  /*!
   * \brief Do not copy another StateDisconnectedRemote into this instance.
   * \vprivate Component Private
   */
  auto operator=(StateDisconnectedRemote const&) noexcept -> StateDisconnectedRemote& = delete;

  /*!
   * \brief Do not move another StateDisconnectedRemote into this instance.
   * \vprivate Component Private
   */
  auto operator=(StateDisconnectedRemote&&) noexcept -> StateDisconnectedRemote& = delete;

  /*!
   * \brief Destruct the StateDisconnectedRemote.
   * \vprivate Component Private
   */
  // VCA_ZEROCOPYCOMMON_SLC_23_DEFAULT_DESTRUCTOR
  ~StateDisconnectedRemote() noexcept final = default;
 ...
 private:
  ...
  /*!
   * \brief The logger of this state disconnected remote.
   */
  ::ara::log::Logger& logger_;

  /*!
   * \brief The side channel of this state disconnected remote.
   */
  side_channel::ClientSideChannel& side_channel_;

  /*!
   * \brief The logic client of this state disconnected remote.
   */
  LogicClientPtr& logic_client_;

  /*!
   * \brief The number of slot tokens given out of this state disconnected remote.
   */
...
#endif  // LIB_MEMCON_INCLUDE_AMSR_ZERO_COPY_COMMON_MEMCON_INTERNAL_CLIENT_STATES_STATE_DISCONNECTED_REMOTE_H_
