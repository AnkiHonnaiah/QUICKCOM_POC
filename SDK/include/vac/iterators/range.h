 ...
 *         \unit  VaCommonLib::Iterators::Range
 *
 ...
 * \tparam  I Type of the value of the range. Only integer type should be used.
 ...
 * \tparam  I The type of the start value, step size and end value of the iterator and its std::size_t
 *          because the range is defined in integer type.
 * \trace   CREQ-VaCommonLib-GeneratorIterator
 */
 ...
 public:
  ...
  class iterator final {
   ...
   public:
     ...
     * \param[in] it The other instance.
     * \spec
     *   requires true;
     * \endspec
     */
     ...
     * \param[in] r Range object which contains all constant information.
     * \param     b The start value for this iterator.
     * \pre       -
     * \spec
     *   requires true;
   ...
   * \endspec
   */
  auto begin() const noexcept -> iterator { return iterator{*this, begin_}; }
   ...
   * \endspec
   */
  auto end() const noexcept -> iterator { return iterator{*this, real_end_}; }
};

/*!
 * \brief  Creates a Range of integers which can be used as iterator.
 * \tparam I Type of the exclusive end value of the range. Only integer type should be used.
