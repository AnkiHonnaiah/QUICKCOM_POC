 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
extern VSECPRIM_FUNC(void) act25519_initCore(VSECPRIM_P2VAR_PARA(actEdwardsCurveWs) ws);
 ...
 *               The buffer referenced by r must provide at least BNDIGITS_256 many actBNDIGITs.
 *               The buffer referenced by a must provide exactly BNDIGITS_512 = 2*BNDIGITS_256 many actBNDIGITs.
 *               a < p^2, where p is the curve prime p = 2^255 - 19
 *  \context     TASK
 *  \reentrant   TRUE, for different workspaces
 *  \synchronous TRUE
 *********************************************************************************************************************/
 ...
 *               in www.rfc-editor.org/rfc/rfc8032#section-5.1
 *  \param[in,out]  ws  Pointer to workspace.
 *  \param[in,out]  r   Pointer to rresult.
 *  \param[in]      a   Pointer to dividend.
 *  \pre         Pointers must be valid.
 *               The buffer referenced by r must provide at least BNDIGITS_256 many actBNDIGITs.
 *               The buffer referenced by a must provide exactly BNDIGITS_512 many actBNDIGITs.
 *  \context     TASK
 *  \reentrant   TRUE, for different workspaces
 *  \synchronous TRUE
 *********************************************************************************************************************/
 ...
 *  \pre         Pointers must be valid.
 *               The buffer referenced by r must provide at least BNDIGITS_256 many actBNDIGITs.
 *               The buffer referenced by a must provide exactly BNDIGITS_256 many actBNDIGITs.
 *               The buffer referenced by b must provide exactly BNDIGITS_256 many actBNDIGITs.
 *  \context     TASK
 *  \reentrant   TRUE, for different workspaces
 *  \synchronous TRUE
 *********************************************************************************************************************/
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
extern VSECPRIM_FUNC(actRETURNCODE) act25519_invModP(
  VSECPRIM_P2VAR_PARA(actEdwardsCurveWs) ws,
  VSECPRIM_P2VAR_PARA(actBNDIGIT) r,
  VSECPRIM_P2CONST_PARA(actBNDIGIT) a,
  VSECPRIM_P2FUNC(VSECPRIM_NONE, void, watchdog)(void));
 ...
 *  \pre         Pointers must be valid.
 *               The buffer referenced by buffer must provide at least BNBYTES_256 many bytes.
 *  \context     TASK
 *  \reentrant   TRUE, for different workspaces
 *  \synchronous TRUE
 *********************************************************************************************************************/
extern VSECPRIM_FUNC(actRETURNCODE) act25519_encodePoint(
  VSECPRIM_P2VAR_PARA(actEdwardsCurveWs) ws,
  VSECPRIM_P2VAR_PARA(actU8) buffer,
  VSECPRIM_P2CONST_PARA(actExtendedHomogeneousPoint) point,
  VSECPRIM_P2FUNC(VSECPRIM_NONE, void, watchdog)(void));
 ...
 *  \param[in]      watchdog  Pointer to watchdog trigger function.
 *  \return      actOK - success
 *               actEXCEPTION_UNKNOWN - No square root found or point not valid or invert 0
 *  \pre         Pointers must be valid.
 *               The buffer referenced by buffer must provide exactly BNBYTES_256 many bytes.
 *  \context     TASK
 *  \reentrant   TRUE, for different workspaces
 *  \synchronous TRUE
 *********************************************************************************************************************/
extern VSECPRIM_FUNC(actRETURNCODE) act25519_decodePoint(
  VSECPRIM_P2VAR_PARA(actEdwardsCurveWs) ws,
  VSECPRIM_P2VAR_PARA(actExtendedHomogeneousPoint) point,
 ...
 *  act25519_addPoint()
 *********************************************************************************************************************/
/*! \brief       actExtendedHomogeneousPoint addition.
...
extern VSECPRIM_FUNC(void) act25519_addPoint(
  VSECPRIM_P2VAR_PARA(actEdwardsCurveWs) ws,
  VSECPRIM_P2VAR_PARA(actExtendedHomogeneousPoint) r,
  VSECPRIM_P2CONST_PARA(actExtendedHomogeneousPoint) p,
  VSECPRIM_P2FUNC(VSECPRIM_NONE, void, watchdog)(void));

/**********************************************************************************************************************
 *  act25519_mulPoint()
 *********************************************************************************************************************/
/*! \brief       actExtendedHomogeneousPoint multiplication.
 ...
 *  \param[in]      watchdog  Pointer to watchdog trigger function.
 *  \pre         Pointers must be valid.
 *               The buffer referenced by s must provide exactly BNDIGITS_256 many actBNDIGITs.
 *  \context     TASK
 *  \reentrant   TRUE, for different workspaces
 *  \synchronous TRUE
 *********************************************************************************************************************/
extern VSECPRIM_FUNC(void) act25519_mulPoint(
  VSECPRIM_P2VAR_PARA(actEdwardsCurveWs) ws,
  VSECPRIM_P2VAR_PARA(actExtendedHomogeneousPoint) r,
  VSECPRIM_P2VAR_PARA(actExtendedHomogeneousPoint) p,
 ...
 *********************************************************************************************************************/
/*! \brief       actExtendedHomogeneousPoint multiplication by point addition.
...
extern VSECPRIM_FUNC(actRETURNCODE) act25519_comparePoints(
  VSECPRIM_P2VAR_PARA(actEdwardsCurveWs) ws,
  VSECPRIM_P2CONST_PARA(actExtendedHomogeneousPoint) p,
  VSECPRIM_P2CONST_PARA(actExtendedHomogeneousPoint) q,
  VSECPRIM_P2FUNC(VSECPRIM_NONE, void, watchdog)(void));
