 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  proxy/cryp/x509_signature.h
 *        \brief  Proxy implementation for ara::crypto::cryp::X509Signature.
 *
 *      \details  Client side implementation of the ara::crypto::cryp::X509Signature interface that
 *                transparently communicates with a server side implementation that performs the real cryptography.
 *
 *********************************************************************************************************************/

#ifndef LIB_LIBCLIENT_INCLUDE_CRYPTO_CLIENT_PROXY_CRYP_X509_SIGNATURE_H_
#define LIB_LIBCLIENT_INCLUDE_CRYPTO_CLIENT_PROXY_CRYP_X509_SIGNATURE_H_
...
/*!
 * \brief Client side proxy implementation for ara::crypto::cryp::X509Signature
 * \vprivate Component Private
 * \trace DSGN-Crypto-ProcessIsolation, DSGN-Crypto-Skeleton_Proxy
 */
class X509Signature : public BaseProxy, public ara::crypto::cryp::X509Signature {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  X509Signature(ara::crypto::cryp::CryptoProvider& provider_reference, amsr::sec::ipc::Transporter& transporter,
   ...
   * \vprivate Component Private
   */
  static std::unique_ptr<X509Signature, ara::crypto::CustomDeleter> Create(
    ...
    return std::unique_ptr<X509Signature, ara::crypto::CustomDeleter>(
        // VECTOR NL AutosarC++17_10-A18.5.2: MD_CRYPTO_AutosarC++17_10-A18.5.2
        new X509Signature(provider_reference, transporter, message_builder, message_serializer, message_deserializer));
  }
   ...
   * \vprivate Component Private
   */
  ara::core::Result<ara::crypto::cryp::Signature::Uptrc> GetSignature(
      ara::crypto::cryp::ReservedObjectIndex reserved_index) const noexcept override;
...
#endif  // LIB_LIBCLIENT_INCLUDE_CRYPTO_CLIENT_PROXY_CRYP_X509_SIGNATURE_H_
