 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  proxy/cryp/secret_seed.h
 *        \brief  Proxy implementation for ara::crypto::cryp::SecretSeed.
 *
 *      \details  Client side implementation of the ara::crypto::cryp::SecretSeed interface that
 *                transparently communicates with a server side implementation that performs the real cryptography.
 *
 *********************************************************************************************************************/

#ifndef LIB_LIBCLIENT_INCLUDE_CRYPTO_CLIENT_PROXY_CRYP_SECRET_SEED_H_
#define LIB_LIBCLIENT_INCLUDE_CRYPTO_CLIENT_PROXY_CRYP_SECRET_SEED_H_
...
/*!
 * \brief Client side proxy implementation for ara::crypto::cryp::SecretSeed
 * \vprivate Component Private
 * \trace DSGN-Crypto-ProcessIsolation, DSGN-Crypto-Skeleton_Proxy
 */
class SecretSeed : public crypto::client::BaseProxy, public ara::crypto::cryp::SecretSeed {
 public:
  /*!
   * \brief Unique constant smart pointer of the proxy.
   * \vprivate Component Private
   */
  using Uptrc = std::unique_ptr<SecretSeed const, ara::crypto::CustomDeleter>;
   ...
   * \vprivate Component Private
   */
  SecretSeed(ara::crypto::cryp::CryptoProvider& provider_reference, amsr::sec::ipc::Transporter& transporter,
   ...
   * \vprivate Component Private
   */
  static std::unique_ptr<SecretSeed, ara::crypto::CustomDeleter> Create(
    ...
    return std::unique_ptr<SecretSeed, ara::crypto::CustomDeleter>(
        new SecretSeed(provider_reference, transporter, message_builder, message_serializer, message_deserializer));
  }
   ...
   * \vprivate Component Private
   */
  ara::core::Result<ara::crypto::cryp::SecretSeed::Uptr> Clone(
      ara::crypto::ReadOnlyMemRegion xor_delta,
   ...
   * \vprivate Component Private
   */
  ara::core::Result<ara::crypto::cryp::SecretSeed&> JumpFrom(ara::crypto::cryp::SecretSeed const& from,
                                                             std::int64_t steps) noexcept override;
   ...
   * \vprivate Component Private
   */
  ara::crypto::cryp::SecretSeed& Next() noexcept override;

  // VECTOR NL AutosarC++17_10-A0.1.5: MD_CRYPTO_AutosarC++17_10-A0.1.5_pure_virtual
  /*!
   ...
   * \vprivate Component Private
   */
  ara::crypto::cryp::SecretSeed& Jump(std::int64_t steps) noexcept override;
   ...
   * \vprivate Component Private
   */
  ara::crypto::cryp::SecretSeed& Xor(ara::crypto::cryp::SecretSeed const& source) noexcept override;
   ...
   * \vprivate Component Private
   */
  ara::crypto::cryp::SecretSeed& Xor(ara::crypto::ReadOnlyMemRegion source) noexcept override;

 private:
  ara::crypto::cryp::CryptoProvider& crypto_provider_; /*!< Reference to the creating provider */
  mutable ara::core::String primitive_name_;           /*!< Primitive name */
  common::util::Logger logger_;                        /*!< Logging instance */

  std::unique_ptr<SecretSeed, ara::crypto::CustomDeleter>
      ref_jump_from_; /*!< Object pointer for the returned reference of JumpFrom */
  std::unique_ptr<SecretSeed, ara::crypto::CustomDeleter>
      ref_jump_; /*!< Object pointer for the returned reference of Jump */
};
...
#endif  // LIB_LIBCLIENT_INCLUDE_CRYPTO_CLIENT_PROXY_CRYP_SECRET_SEED_H_
