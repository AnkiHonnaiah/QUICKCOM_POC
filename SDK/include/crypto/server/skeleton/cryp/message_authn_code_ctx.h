 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/message_authn_code_ctx.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::MessageAuthnCodeCtx.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_MESSAGE_AUTHN_CODE_CTX_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_MESSAGE_AUTHN_CODE_CTX_H_
 ...
 */
class MessageAuthnCodeCtx : public BaseSkeletonImpl<ara::crypto::cryp::MessageAuthnCodeCtx,
                                                    amsr::sec::ipc::ara_crypto_cryp_MessageAuthnCodeCtx> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  MessageAuthnCodeCtx(MessageAuthnCodeCtx const& /*other*/) = default;
   ...
   * \vprivate Component Private
   */
  MessageAuthnCodeCtx(MessageAuthnCodeCtx&& /*other*/) noexcept = default;
   ...
   * \vprivate Component Private
   */
  MessageAuthnCodeCtx& operator=(MessageAuthnCodeCtx&& /*other*/) & noexcept = delete;
 ...
 protected:
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_cryp_MessageAuthnCodeCtx task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_MESSAGE_AUTHN_CODE_CTX_H_
