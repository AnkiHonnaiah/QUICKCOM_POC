 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/x509_request_signer_ctx.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::X509RequestSignerCtx.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_X509_REQUEST_SIGNER_CTX_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_X509_REQUEST_SIGNER_CTX_H_
 ...
 */
class X509RequestSignerCtx : public BaseSkeletonImpl<ara::crypto::cryp::X509RequestSignerCtx,
                                                     amsr::sec::ipc::ara_crypto_cryp_X509RequestSignerCtx> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  X509RequestSignerCtx(X509RequestSignerCtx const& /*other*/) = default;

  /*!
   * \brief Default Destructor
   * \vprivate Component Private
   */
  ~X509RequestSignerCtx() noexcept override = default;

  /*!
   * \brief Default move constructor
   * \vprivate Component Private
   */
  X509RequestSignerCtx(X509RequestSignerCtx&& /*other*/) noexcept = default;
   ...
   * \vprivate Component Private
   */
  X509RequestSignerCtx& operator=(X509RequestSignerCtx const& /*other*/) & = delete;
   ...
   * \vprivate Component Private
   */
  X509RequestSignerCtx& operator=(X509RequestSignerCtx&& /*other*/) & noexcept = delete;
 ...
 protected:
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_cryp_X509RequestSignerCtx task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_X509_REQUEST_SIGNER_CTX_H_
