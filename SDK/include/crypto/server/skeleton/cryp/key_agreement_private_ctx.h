 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/key_agreement_private_ctx.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::KeyAgreementPrivateCtx.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_KEY_AGREEMENT_PRIVATE_CTX_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_KEY_AGREEMENT_PRIVATE_CTX_H_
 ...
 */
class KeyAgreementPrivateCtx : public BaseSkeletonImpl<ara::crypto::cryp::KeyAgreementPrivateCtx,
                                                       amsr::sec::ipc::ara_crypto_cryp_KeyAgreementPrivateCtx> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  KeyAgreementPrivateCtx(KeyAgreementPrivateCtx const& /*other*/) = default;

  /*!
   * \brief Default Destructor
   * \vprivate Component Private
   */
  ~KeyAgreementPrivateCtx() noexcept override = default;

  /*!
   * \brief Default move constructor
   * \vprivate Component Private
   */
  KeyAgreementPrivateCtx(KeyAgreementPrivateCtx&& /*other*/) noexcept = default;
   ...
   * \vprivate Component Private
   */
  KeyAgreementPrivateCtx& operator=(KeyAgreementPrivateCtx&& /*other*/) & noexcept = delete;
 ...
 protected:
   ...
   * \vprivate Component Private
   */
  auto DispatchMethod(amsr::sec::ipc::ara_crypto_cryp_KeyAgreementPrivateCtx task,
                      ara::crypto::ReadOnlyMemRegion input_buffer,
                      ara::crypto::WritableMemRegion output_buffer) noexcept
      -> ara::core::Result<ara::crypto::ReadOnlyMemRegion> override;
};
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_KEY_AGREEMENT_PRIVATE_CTX_H_
