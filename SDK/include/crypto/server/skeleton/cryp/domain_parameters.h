 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/domain_parameters.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::DomainParameters.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_DOMAIN_PARAMETERS_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_DOMAIN_PARAMETERS_H_
...
class DomainParameters
    : public BaseSkeletonImpl<ara::crypto::cryp::DomainParameters, amsr::sec::ipc::ara_crypto_cryp_DomainParameters> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  DomainParameters(DomainParameters const& /*other*/) = default;

  /*!
   * \brief Default Destructor
   * \vprivate Component Private
   */
  ~DomainParameters() noexcept override = default;

  /*!
   * \brief Default move constructor
   * \vprivate Component Private
   */
  DomainParameters(DomainParameters&& /*other*/) noexcept = default;
   ...
   * \vprivate Component Private
   */
  DomainParameters& operator=(DomainParameters const& /*other*/) & = delete;
   ...
   * \vprivate Component Private
   */
  DomainParameters& operator=(DomainParameters&& /*other*/) & noexcept = delete;
 ...
 protected:
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_cryp_DomainParameters task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_DOMAIN_PARAMETERS_H_
