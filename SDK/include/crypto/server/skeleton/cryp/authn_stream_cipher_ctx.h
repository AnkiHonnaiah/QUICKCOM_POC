 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/authn_stream_cipher_ctx.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::AuthnStreamCipherCtx.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_AUTHN_STREAM_CIPHER_CTX_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_AUTHN_STREAM_CIPHER_CTX_H_
 ...
 */
class AuthnStreamCipherCtx : public BaseSkeletonImpl<ara::crypto::cryp::AuthnStreamCipherCtx,
                                                     amsr::sec::ipc::ara_crypto_cryp_AuthnStreamCipherCtx> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  AuthnStreamCipherCtx(AuthnStreamCipherCtx const& /*other*/) = default;

  /*!
   * \brief Default Destructor
   * \vprivate Component Private
   */
  ~AuthnStreamCipherCtx() noexcept override = default;

  /*!
   * \brief Default move constructor
   * \vprivate Component Private
   */
  AuthnStreamCipherCtx(AuthnStreamCipherCtx&& /*other*/) noexcept = default;
   ...
   * \vprivate Component Private
   */
  AuthnStreamCipherCtx& operator=(AuthnStreamCipherCtx const& /*other*/) & = delete;
   ...
   * \vprivate Component Private
   */
  AuthnStreamCipherCtx& operator=(AuthnStreamCipherCtx&& /*other*/) & noexcept = delete;
 ...
 protected:
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_cryp_AuthnStreamCipherCtx task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_AUTHN_STREAM_CIPHER_CTX_H_
