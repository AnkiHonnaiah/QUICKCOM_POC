 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/signer_private_ctx.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::SignerPrivateCtx.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_SIGNER_PRIVATE_CTX_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_SIGNER_PRIVATE_CTX_H_
...
class SignerPrivateCtx
    : public BaseSkeletonImpl<ara::crypto::cryp::SignerPrivateCtx, amsr::sec::ipc::ara_crypto_cryp_SignerPrivateCtx> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  SignerPrivateCtx(SignerPrivateCtx const& /*other*/) = default;

  /*!
   * \brief Default move constructor
   * \vprivate Component Private
   */
  SignerPrivateCtx(SignerPrivateCtx&& /*other*/) noexcept = default;
   ...
   * \vprivate Component Private
   */
  SignerPrivateCtx& operator=(SignerPrivateCtx&& /*other*/) & noexcept = delete;
 ...
 protected:
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_cryp_SignerPrivateCtx task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_SIGNER_PRIVATE_CTX_H_
