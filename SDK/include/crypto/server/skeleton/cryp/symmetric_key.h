 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/symmetric_key.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::SymmetricKey.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_SYMMETRIC_KEY_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_SYMMETRIC_KEY_H_
 ...
 */
class SymmetricKey
    : public BaseSkeletonImpl<ara::crypto::cryp::SymmetricKey, amsr::sec::ipc::ara_crypto_cryp_SymmetricKey> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  SymmetricKey(SymmetricKey const& /*other*/) = default;

  /*!
   * \brief Default Destructor
   * \vprivate Component Private
   */
  ~SymmetricKey() noexcept override = default;

  /*!
   * \brief Default move constructor
   * \vprivate Component Private
   */
  SymmetricKey(SymmetricKey&& /*other*/) noexcept = default;
   ...
   * \vprivate Component Private
   */
  SymmetricKey& operator=(SymmetricKey const& /*other*/) & = delete;
   ...
   * \vprivate Component Private
   */
  SymmetricKey& operator=(SymmetricKey&& /*other*/) & noexcept = delete;
 ...
 protected:
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_cryp_SymmetricKey task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_SYMMETRIC_KEY_H_
