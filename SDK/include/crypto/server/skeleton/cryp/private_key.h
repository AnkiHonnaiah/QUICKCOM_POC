 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/private_key.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::PrivateKey.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_PRIVATE_KEY_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_PRIVATE_KEY_H_
 ...
 */
class PrivateKey : public BaseSkeletonImpl<ara::crypto::cryp::PrivateKey, amsr::sec::ipc::ara_crypto_cryp_PrivateKey> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  PrivateKey(PrivateKey const& /*other*/) = default;
 ...
 protected:
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_cryp_PrivateKey task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_PRIVATE_KEY_H_
