 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/x509_public_key_info.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::X509PublicKeyInfo.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_X509_PUBLIC_KEY_INFO_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_X509_PUBLIC_KEY_INFO_H_
...
class X509PublicKeyInfo
    : public BaseSkeletonImpl<ara::crypto::cryp::X509PublicKeyInfo, amsr::sec::ipc::ara_crypto_cryp_X509PublicKeyInfo> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  X509PublicKeyInfo(X509PublicKeyInfo const& /*other*/) = default;

  /*!
   * \brief Default Destructor
   * \vprivate Component Private
   */
  ~X509PublicKeyInfo() noexcept override = default;

  /*!
   * \brief Default move constructor
   * \vprivate Component Private
   */
  X509PublicKeyInfo(X509PublicKeyInfo&& /*other*/) noexcept = default;
   ...
   * \vprivate Component Private
   */
  X509PublicKeyInfo& operator=(X509PublicKeyInfo const& /*other*/) & = delete;
   ...
   * \vprivate Component Private
   */
  X509PublicKeyInfo& operator=(X509PublicKeyInfo&& /*other*/) & noexcept = delete;
 ...
 protected:
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_cryp_X509PublicKeyInfo task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_X509_PUBLIC_KEY_INFO_H_
