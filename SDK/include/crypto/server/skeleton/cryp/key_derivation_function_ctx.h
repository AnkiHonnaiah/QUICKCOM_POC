 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/key_derivation_function_ctx.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::KeyDerivationFunctionCtx.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_KEY_DERIVATION_FUNCTION_CTX_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_KEY_DERIVATION_FUNCTION_CTX_H_
 ...
 */
class KeyDerivationFunctionCtx : public BaseSkeletonImpl<ara::crypto::cryp::KeyDerivationFunctionCtx,
                                                         amsr::sec::ipc::ara_crypto_cryp_KeyDerivationFunctionCtx> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  ~KeyDerivationFunctionCtx() noexcept override = default;

  /*!
   * \brief Default copy constructor
   * \vprivate Component Private
   */
  KeyDerivationFunctionCtx(KeyDerivationFunctionCtx const& /*other*/) = default;

  /*!
   * \brief Default move constructor
   * \vprivate Component Private
   */
  KeyDerivationFunctionCtx(KeyDerivationFunctionCtx&& /*other*/) noexcept = default;
   ...
   * \vprivate Component Private
   */
  KeyDerivationFunctionCtx& operator=(KeyDerivationFunctionCtx&& /*other*/) & noexcept = delete;
 ...
 protected:
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_cryp_KeyDerivationFunctionCtx task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_KEY_DERIVATION_FUNCTION_CTX_H_
