 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/x509_algorithm_id.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::X509AlgorithmId.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_X509_ALGORITHM_ID_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_X509_ALGORITHM_ID_H_
...
class X509AlgorithmId
    : public BaseSkeletonImpl<ara::crypto::cryp::X509AlgorithmId, amsr::sec::ipc::ara_crypto_cryp_X509AlgorithmId> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  X509AlgorithmId(X509AlgorithmId const& /*other*/) = default;

  /*!
   * \brief Default Destructor
   * \vprivate Component Private
   */
  ~X509AlgorithmId() noexcept override = default;

  /*!
   * \brief Default move constructor
   * \vprivate Component Private
   */
  X509AlgorithmId(X509AlgorithmId&& /*other*/) noexcept = default;
   ...
   * \vprivate Component Private
   */
  X509AlgorithmId& operator=(X509AlgorithmId const& /*other*/) & = delete;
   ...
   * \vprivate Component Private
   */
  X509AlgorithmId& operator=(X509AlgorithmId&& /*other*/) & noexcept = delete;
 ...
 protected:
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_cryp_X509AlgorithmId task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_X509_ALGORITHM_ID_H_
