 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/verifier_public_ctx.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::VerifierPublicCtx.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_VERIFIER_PUBLIC_CTX_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_VERIFIER_PUBLIC_CTX_H_
...
class VerifierPublicCtx
    : public BaseSkeletonImpl<ara::crypto::cryp::VerifierPublicCtx, amsr::sec::ipc::ara_crypto_cryp_VerifierPublicCtx> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  VerifierPublicCtx(VerifierPublicCtx const& /*other*/) = default;

  /*!
   * \brief Default destructor
   * \vprivate Component Private
   */
  ~VerifierPublicCtx() noexcept override = default;

  /*!
   * \brief Default move constructor
   * \vprivate Component Private
   */
  VerifierPublicCtx(VerifierPublicCtx&& /*other*/) noexcept = default;
   ...
   * \vprivate Component Private
   */
  VerifierPublicCtx& operator=(VerifierPublicCtx&& /*other*/) & noexcept = delete;
 ...
 protected:
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_cryp_VerifierPublicCtx task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_VERIFIER_PUBLIC_CTX_H_
