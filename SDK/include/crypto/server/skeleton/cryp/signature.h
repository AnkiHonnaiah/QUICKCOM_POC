 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/cryp/signature.h
 *        \brief  Skeleton implementation for ara::crypto::cryp::Signature.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_SIGNATURE_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_SIGNATURE_H_
 ...
 */
class Signature : public BaseSkeletonImpl<ara::crypto::cryp::Signature, amsr::sec::ipc::ara_crypto_cryp_Signature> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  Signature& operator=(Signature&& /*other*/) & noexcept = delete;
 ...
 protected:
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_cryp_Signature task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_CRYP_SIGNATURE_H_
