 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/x509/cert_sign_request.h
 *        \brief  Skeleton implementation for ara::crypto::x509::CertSignRequest.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_X509_CERT_SIGN_REQUEST_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_X509_CERT_SIGN_REQUEST_H_
...
#include "crypto/server/skeleton/cryp/x509_public_key_info.h"
...
/*!
 * \brief Server side implementation for the skeleton of ara::crypto::x509::CertSignRequest.
 * \vprivate Component Private
 */
class CertSignRequest
    : public BaseSkeletonImpl<ara::crypto::x509::CertSignRequest, amsr::sec::ipc::ara_crypto_x509_CertSignRequest> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  CertSignRequest(CertSignRequest const& /*other*/) = default;

  /*!
   * \brief Default move constructor
   * \vprivate Component Private
   */
  CertSignRequest(CertSignRequest&& /*other*/) noexcept = default;
   ...
   * \vprivate Component Private
   */
  CertSignRequest& operator=(CertSignRequest&& /*other*/) & noexcept = delete;
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_x509_CertSignRequest task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_X509_CERT_SIGN_REQUEST_H_
