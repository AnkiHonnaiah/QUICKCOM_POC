 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  skeleton/x509/certificate.h
 *        \brief  Skeleton implementation for ara::crypto::x509::Certificate.
 *
...
#ifndef LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_X509_CERTIFICATE_H_
#define LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_X509_CERTIFICATE_H_
...
/*!
 * \brief Server side implementation for the skeleton of ara::crypto::x509::Certificate.
 * \vprivate Component Private
 * \trace DSGN-Crypto-ProcessIsolation, DSGN-Crypto-Skeleton_Proxy
 */
class Certificate final
    : public BaseSkeletonImpl<ara::crypto::x509::Certificate, amsr::sec::ipc::ara_crypto_x509_Certificate> {
 public:
  /*!
   ...
   * \vprivate Component Private
   */
  Certificate(Certificate const& /*other*/) = default;
  ...
  ara::core::Result<ara::crypto::ReadOnlyMemRegion> DispatchMethod(
      amsr::sec::ipc::ara_crypto_x509_Certificate task, ara::crypto::ReadOnlyMemRegion input_buffer,
...
#endif  // LIB_LIBSERVER_INCLUDE_CRYPTO_SERVER_SKELETON_X509_CERTIFICATE_H_
