 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *  Benjamin Walter               Bwa           Vector Informatik GmbH
 *  -------------------------------------------------------------------------------------------------------------------
 *  REVISION HISTORY
 *  -------------------------------------------------------------------------------------------------------------------
 *  Version   Date        Author  Change Id     Description
 *  -------------------------------------------------------------------------------------------------------------------
 *  01.00.00  2019-07-15  Bwa                   Initial creation as customer template for CustomerDE projects
 *                                              The chosen default values are taken from the Arm32 platform with GNU
 *                                              and have to be verified/modified for the depending customer platform
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
/* ##V_CFG_MANAGEMENT ##CQProject : CommonAsr_Generic_Generic CQComponent : Impl_CompAbstract_Generic */
#define COMMONASR_GENERIC_GENERIC_IMPL_COMPABSTRACT_VERSION 0x0100
#define COMMONASR_GENERIC_GENERIC_IMPL_COMPABSTRACT_RELEASE_VERSION 0x00
...
#ifndef NULL_PTR
// #error "Compiler.h: setup here the compiler expression for null pointer"
#define NULL_PTR ((void*)0)
#endif

/* INLINE  define for abstraction of the keyword inline*/
#ifndef INLINE
// #error "Compiler.h: setup here the statement for inline"
...
#ifndef LOCAL_INLINE
// #error "Compiler.h: setup here the compiler statement for inline"
 ...
 */
/* fill in the memclass and rettype in the correct order according to the used compiler */
...
/* FUNC_P2CONST macro for declaration and definition of functions returning a pointer to a constant, that ensures
   ...
   memclass    classification of the function itself
 */
/* fill in the ptrclass, memclass, rettype and * in the correct order according to the used compiler */
...
/* P2VAR macro for the declaration and definition of pointers in RAM, pointing to variables
   ...
   ptrclass    defines the classification of the pointer's distance
 */
/* fill in the ptrtype, memclass, ptrclass and the * in the correct order according to the used compiler */
 ...
 */
/* fill in the const, ptrtype, memclass, ptrclass and * in the correct order according to the used compiler */
...
/* CONSTP2CONST macro for the declaration and definition of constant pointers accessing constants
   ...
   ptrclass    defines the classification of the pointer distance
 */
/* fill in the 2 const, ptrtype, memclass, ptrclass and * in the correct order according to the used compiler */
 ...
 */
/* fill in the rettype, ptrclass, fctname and * in the correct order according to the used compiler */
 ...
 */
/* fill in the const, type and memclass in the correct order according to the used compiler */
 ...
 */
/* fill in the vartype and memclass in the correct order according to the used compiler */
...
MD_Compiler_19.10:
  Reason: Macro used in structures, which depend on used compiler and which do not allow brackets e.g. declaration of
functions and variables. Risk: None atomic parameter lead to compile errors. Prevention: Used parameter is always
atomic.
