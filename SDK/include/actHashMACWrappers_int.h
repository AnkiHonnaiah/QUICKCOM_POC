...
# ifdef VSECPRIM_WRAPPER_HMAC_SHA1 /* COV_VSECPRIM_NO_SAFE_CONFIG XF */
  case actHASHMACSHA1_ALGO_ID:
    actHashMACFinalize(&(info->hmac_sha1), hash, watchdog); /* SBSW_VSECPRIM_FCT_CALL_PASSED_BUFFER */
    break;
# endif

# ifdef VSECPRIM_WRAPPER_HMAC_SHA256
  case actHASHMACSHA256_ALGO_ID:
    actHashMACSHA256Finalize(&(info->hmac_sha256), hash, watchdog); /* SBSW_VSECPRIM_FCT_CALL_PASSED_BUFFER */
    break;
# endif

# ifdef VSECPRIM_WRAPPER_HMAC_SHA384 /* COV_VSECPRIM_NO_SAFE_CONFIG XF */
  case actHASHMACSHA384_ALGO_ID:
    actHashMACSHA384Finalize(&(info->hmac_sha384), hash, watchdog); /* SBSW_VSECPRIM_FCT_CALL_PASSED_BUFFER */
    break;
# endif
