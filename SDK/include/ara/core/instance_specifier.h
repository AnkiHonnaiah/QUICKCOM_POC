 ...
 *         \unit  VaCommonLib::ContainerLibrary::InstanceSpecifier
 *
 *********************************************************************************************************************/
 ...
 * \trace SPEC-7552586, CREQ-VaCommonLib-InstanceSpecifier
 * \vpublic
 */
class InstanceSpecifier final {
 public:
   ...
   * \param[in] metaModelIdentifier meta model identifier (short name path) where path separator is '/'.
   * \pre       -
   * \return    Result containing construction token from which an instance specifier can be
   *            constructed or an error code.
   * \error     InstanceSpecifierErrc::invalid_path_short_name if construction failed.
   * \spec
   *   requires true;
   * \endspec
   * \trace     SPEC-7552590
   ...
   * \param[in] token ConstructionToken obtained via Pre-construct.
   * \pre       -
   * \spec
   *   requires true;
   * \endspec
   ...
   * \param[in] metaModelIdentifier Stringfied form of InstanceSpecifier.
   * \pre       -
   * \return    Result containing valid InstanceSpecifier or an error code.
   * \error     InstanceSpecifierErrc::invalid_path_short_name if construction failed.
   * \spec
   *   requires true;
   * \endspec
   ...
   * \param[in] other String representation of model element to compare this one with.
   * \pre       -
