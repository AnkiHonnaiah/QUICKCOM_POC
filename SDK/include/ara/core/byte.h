 ...
 * \param[in] b The byte value to cast.
 * \pre       -
 ...
 * \param[in] b The integer to cast (must be smaller or equal to 0xFF).
 * \pre       -
 ...
 * \param[in] i The integer literal from which to create the byte.
