 ...
 *         \unit  VaCommonLib::LanguageSupport::AsynchronousOperations::FutureErrorDomain
 *
 *********************************************************************************************************************/
 ...
 * \trace DSGN-VaCommonLib-AsynchronousOperations, SPEC-7552452
 * \vpublic
 */
...
/*!
 * \brief Error domain for errors originating from classes Future and Promise.
 * \trace SPEC-7552454, DSGN-VaCommonLib-AsynchronousOperations
 * \vpublic
 */
class FutureErrorDomain final : public ErrorDomain {
  /*!
   * \brief The Future error domain id
   * \trace SPEC-7552370, SPEC-7552372
   */
 ...
 public:
   ...
   *   requires true;
   * \endspec
   * \trace SPEC-7552457, SPEC-7552372
   * \vpublic
   */
   ...
   *   requires true;
   * \endspec
   * \trace  SPEC-7552458, SPEC-7552372
   * \vpublic
   */
 ...
 * \param[in] code Enumeration value from future_errc.
 * \param[in] data Vendor-defined supplementary value.
