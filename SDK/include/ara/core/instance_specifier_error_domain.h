 ...
 * \trace CREQ-VaCommonLib-InstanceSpecifier
 * \vprivate
 */
...
class InstanceSpecifierErrorDomain final : public ErrorDomain {
 public:
   ...
   * \param[in] error_code The error code value.
   * \pre       -
 ...
 * \param[in] code An enumeration value from instance_specifier_errc.
