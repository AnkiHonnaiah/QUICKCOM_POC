 ...
 *         \unit  VaCommonLib::ErrorHandling::Exception
 *
 *********************************************************************************************************************/
...
class Exception : public std::exception {
 public:
   ...
   * \vpublic
   */
  explicit Exception(ErrorCode error_code) noexcept : std::exception(), error_code_{error_code} {}
   ...
   * \endspec
   */
  ~Exception() noexcept override = default;  // VCA_VAC_SAFE_DEALLOCATION
