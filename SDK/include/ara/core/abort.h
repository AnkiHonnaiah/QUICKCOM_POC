 ...
 *         \unit  VaCommonLib::ErrorHandling::Abort
 *
 *********************************************************************************************************************/
 ...
 * \param[in] handler pointer to the callback to use. If set to nullptr, no custom abort handler will be used.
 * \pre       -
 ...
 * \note    The type of the text argument is a raw pointer (instead of a more "modern" type such as StringView) in
 *          order to increase the chances that the function call succeeds even in situations when e.g. the stack has
 *          been corrupted.
