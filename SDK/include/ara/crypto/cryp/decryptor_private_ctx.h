 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  ara/crypto/cryp/decryptor_private_ctx.h
 *        \brief  Asymmetric Decryption Private key Context interface.
 *
 *********************************************************************************************************************/

#ifndef LIB_LIBARA_INCLUDE_ARA_CRYPTO_CRYP_DECRYPTOR_PRIVATE_CTX_H_
#define LIB_LIBARA_INCLUDE_ARA_CRYPTO_CRYP_DECRYPTOR_PRIVATE_CTX_H_
 ...
 * \vpublic
 */
class DecryptorPrivateCtx : public PrivateKeyContext, public BlockCryptor {
 public:
  /*!
...
#endif  // LIB_LIBARA_INCLUDE_ARA_CRYPTO_CRYP_DECRYPTOR_PRIVATE_CTX_H_
