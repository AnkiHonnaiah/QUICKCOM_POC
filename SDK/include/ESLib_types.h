...
# define ESL_WST_ALGO_HKDF_HASH_ONESTEP                               (0x0B80u)
# define ESL_WST_ALGO_HKDF_HMAC_SHA384                                (0x0C80u)
# define ESL_WST_ALGO_EDWARDS_DSA                                     (0x0E80u)
# define ESL_WST_ALGO_EDDH                                            (0x0D80u)
# define ESL_WST_ALGO_HMACSHA512                                      (ESL_WST_ALGO_HMACSHA384)
# define ESL_WST_ALGO_ECP_KEYCHECK                                    (0x0F80u)
# define ESL_WST_ALGO_EDWARDS_KEYCHECK                                (0x1180u)
