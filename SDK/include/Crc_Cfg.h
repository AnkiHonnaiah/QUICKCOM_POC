 ...
 *    License Scope : The usage is restricted to CBD1900136_D05
 *
 *  -------------------------------------------------------------------------------------------------------------------
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Crc_Cfg.h
 *   Generation Time: 2020-06-30 14:45:14
 *           Project: Demo - Version 1.0
 *          Delivery: CBD1900136_D05
 *      Tool Version: DaVinci Configurator  5.22.12 S-3
 *
 *
 *********************************************************************************************************************/
...
#define CRC_16_MODE (CRC_16_TABLE_4)
#define CRC_32_MODE (CRC_32_TABLE)
#define CRC_32P4_MODE (CRC_32P4_TABLE_4)
