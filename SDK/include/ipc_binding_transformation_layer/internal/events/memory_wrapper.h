 ...
 *
 *********************************************************************************************************************/
#ifndef LIB_IPC_BINDING_TRANSFORMATION_LAYER_INCLUDE_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_EVENTS_MEMORY_WRAPPER_H_
#define LIB_IPC_BINDING_TRANSFORMATION_LAYER_INCLUDE_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_EVENTS_MEMORY_WRAPPER_H_
...
class MemoryWrapper final : public ::amsr::socal::internal::events::MemoryWrapperInterface<SampleType> {
 public:
   ...
   * \spec requires true; \endspec
   */
  ~MemoryWrapper() noexcept final = default;  // VCA_IPCB_MOLE_1298

  MemoryWrapper(MemoryWrapper&&) noexcept = delete;
  auto operator=(MemoryWrapper&&) noexcept -> MemoryWrapper& = delete;
  MemoryWrapper(MemoryWrapper const&) noexcept = delete;
  auto operator=(MemoryWrapper const&) noexcept -> MemoryWrapper& = delete;
   ...
   * \spec requires true; \endspec
   */
  auto operator->() noexcept -> SampleDataType* final { return &sample_; }
...
#endif  // LIB_IPC_BINDING_TRANSFORMATION_LAYER_INCLUDE_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_EVENTS_MEMORY_WRAPPER_H_
