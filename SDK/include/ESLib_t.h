...
# define ESL_HA_SHA1                                                  (actHA_SHA1)
# define ESL_HA_SHA2_224                                              (actHA_SHA2_224)
# define ESL_HA_SHA2_256                                              (actHA_SHA2_256)
# define ESL_HA_SHA2_384                                              (actHA_SHA2_384)
# define ESL_HA_SHA2_512                                              (actHA_SHA2_512)
# define ESL_HA_SHA2_512_224                                          (actHA_SHA2_512_224)
# define ESL_HA_SHA2_512_256                                          (actHA_SHA2_512_256)
/* The SHA3 identifiers need to be direct successors to each other! This is used in vSecPrim_initHash(). */
# define ESL_HA_SHA3_224                                              (actHA_SHA3_224)
# define ESL_HA_SHA3_256                                              (actHA_SHA3_256)
# define ESL_HA_SHA3_384                                              (actHA_SHA3_384)
# define ESL_HA_SHA3_512                                              (actHA_SHA3_512)
/* The SHAKE identifiers need to be direct successors to each other! This is used in vSecPrim_initHash(). */
# define ESL_HA_SHAKE_128                                             (actHA_SHAKE_128)
# define ESL_HA_SHAKE_256                                             (actHA_SHAKE_256)
# define ESL_HA_RMD160                                                (actHA_RMD160)
# define ESL_HA_MD5                                                   (actHA_MD5)
...
# define ESL_INSTANCE_Ed25519CTX                                      ESL_INSTANCE_Ed25519ctx    /* MUST match actEd25519ctx */
# define ESL_INSTANCE_Ed25519PH                                       ESL_INSTANCE_Ed25519ph     /* MUST match actEd25519ph */
...
# define ESL_SIZEOF_Ed448_KEY                                         57u
# define ESL_SIZEOF_Ed448_SECRET_KEY                                  ESL_SIZEOF_Ed448_KEY
# define ESL_SIZEOF_Ed448_PUBLIC_KEY                                  ESL_SIZEOF_Ed448_KEY
# define ESL_INSTANCE_Ed448                                           actEd448PURE          /* MUST match actEd448pure */
# define ESL_INSTANCE_Ed448PH                                         actEd448PH            /* MUST match actEd448ph */
# define ESL_SIZEOF_Ed448_SIGNATURE                                   actEd448_SIGNATURE_SIZE

# define ESL_SIZEOF_X448_KEY                                          56u
# define ESL_SIZEOF_X448_PRIVATE_KEY                                  ESL_SIZEOF_X448_KEY
# define ESL_SIZEOF_X448_PUBLIC_KEY                                   ESL_SIZEOF_X448_KEY
# define ESL_SIZEOF_X448_SHARED_SECRET                                ESL_SIZEOF_X448_KEY

# define ESL_EDWARDS_CONTEXT_LENGTH                                   (255u)


# define ESL_CURVE25519                                               actEDWARDSCURVE25519
# define ESL_CURVE448                                                 actEDWARDSCURVE448
/* Keep previous definition for compatibility */
# define ESL_Curve25519                                               ESL_CURVE25519
...
/* HMACSHA-512 workSpace sizes */
/* For (init, update(input, len), ... , update(input, len), finalize) sequences */
# define ESL_MAXSIZEOF_WS_HMACSHA512                                  (sizeof(actHASHMACSHA512STRUCT))
...
#define ESL_SIZEOF_WS_ECP_KEY_CHECK                                   sizeof(eslt_WorkSpaceEcPKeyCheck) 
...
# define ESL_SIZEOF_WS_RSA_OAEP_DECODING                              (sizeof(eslt_EMBuffer) + sizeof(actWorkSpaceUnionHashFunctions_RSA) + sizeof(eslt_Length))
...
/* =============================================================================
 ...
 ============================================================================= */
# define ESL_SIZEOF_WS_Ed25519                                        (sizeof(actEdDSASTRUCT))
# define ESL_SIZEOF_WS_X25519                                         (sizeof(actEdDHSTRUCT))
/* workspace sizes both for edwards25519/edwards448 and curve25519/curve448 */
# define ESL_SIZEOF_WS_EDDSA                                          (sizeof(actEdDSASTRUCT))
# define ESL_SIZEOF_WS_EDDH                                           (sizeof(actEdDHSTRUCT))
# define ESL_SIZEOF_WS_EDKEYCHECK                                     (sizeof(actEdwardsKeyCheck))
...
{
  eslt_WorkSpaceHeader header;
  actHASHMACSHA512STRUCT wsHMACSHA512;
} eslt_WorkSpaceHMACSHA512;
...
{
  eslt_WorkSpaceHeader header;
  act_WorkSpaceEcPKeyCheck workspaceKeyCheck;
...
/* Definition kept for compatibility reasons because the type is still used in function esl_calcSaltedHashRSA_PSS(). */
typedef actWorkSpaceUnionHashFunctions_RSA eslt_WorkSpaceUnionHashFunctions_RSA;
...
typedef struct
{
  ...
  VSECPRIM_P2VAR_PARA(actWorkSpaceUnionHashFunctions_RSA) wsHashUnionPtr;
...
typedef struct
{
  eslt_WorkSpaceHeader header;
  eslt_Byte messageBuffer[Esl_BitsToBytes(ESL_RSA_KEYSIZE)];
  actWorkSpaceUnionHashFunctions_RSA wsHashUnion;
...
{
  eslt_WorkSpaceHeader header;
  actEdDSASTRUCT wsEdDSABuffer;
  VSECPRIM_P2VAR_PARA(eslt_Byte) wsEd25519; /* Backward compatible pointer */
} eslt_WorkSpaceEdDSA;

/* Compatibility: */
typedef eslt_WorkSpaceEdDSA eslt_WorkSpaceEd25519;

typedef struct
{
  eslt_WorkSpaceHeader header;
  actEdDHSTRUCT wsEdDHBuffer;
  VSECPRIM_P2VAR_PARA(eslt_Byte) wsX25519; /* Backward compatible pointer */
} eslt_WorkSpaceEdDH;

/* Compatibility: */
typedef eslt_WorkSpaceEdDH eslt_WorkSpaceX25519;

/* Workspace for key validity checks for Ed25519 and Ed448 */
typedef struct
{
  eslt_WorkSpaceHeader header;
  actEdwardsKeyCheck wsEdKeyCheck;
} eslt_WorkSpaceEdKeyCheck;
