 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  SpeedMonitorExecutable/include/services/speedlimitservice/SpeedLimitService_datatypes.h
...
#ifndef SPEEDMONITOREXECUTABLE_INCLUDE_SERVICES_SPEEDLIMITSERVICE_SPEEDLIMITSERVICE_DATATYPES_H_
#define SPEEDMONITOREXECUTABLE_INCLUDE_SERVICES_SPEEDLIMITSERVICE_SPEEDLIMITSERVICE_DATATYPES_H_
...
#endif  // SPEEDMONITOREXECUTABLE_INCLUDE_SERVICES_SPEEDLIMITSERVICE_SPEEDLIMITSERVICE_DATATYPES_H_
