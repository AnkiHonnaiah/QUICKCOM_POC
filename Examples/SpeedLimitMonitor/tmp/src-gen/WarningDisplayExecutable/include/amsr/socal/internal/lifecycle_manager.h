 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  WarningDisplayExecutable/include/amsr/socal/internal/lifecycle_manager.h
...
#ifndef WARNINGDISPLAYEXECUTABLE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
#define WARNINGDISPLAYEXECUTABLE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
...
class LifecycleManager final {
 public:
  ...
  static void Initialize() noexcept {
    ...
    services::speedlimitservice::proxy::SpeedLimitServiceProxy::CreateSingletons();
  ...
  static void Deinitialize() noexcept {
    ...
    services::speedlimitservice::proxy::SpeedLimitServiceProxy::DestroySingletons();
...
#endif  // WARNINGDISPLAYEXECUTABLE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
