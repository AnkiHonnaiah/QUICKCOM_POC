 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  WarningDisplayExecutable/src/amsr/ipc_binding/internal/target_dependent/deinitializer.cpp
...
void Deinitializer::DeinitializeProvidedServiceInstances(RuntimeConfig const&) const noexcept {}
...
void Deinitializer::DeinitializeRequiredServiceInstances(RuntimeConfig const& runtime_config) const noexcept {
  ...
  // is_generic: false
  {
    ...
    logger_.LogDebug(
        ...
        s << "Deinitializing RequiredServiceInstances of ServiceInterfaceDeployment '" << service_shortname_path << "'.";
        },
        Logger::LogLocation{static_cast<char const*>(__func__), __LINE__});
    ...
    amsr::ipc_binding::internal::RequiredServiceInstanceBackendInitializer::DeinitializeRequiredServiceInstances<ProxyBackendInterface>(
      service_config, Proxy::GetFactoryRegistry());
